    ...
    public function move($id, $is_report = false, $is_origin_api = false)
    {
        ...
        if ($lead !== null) {
            ...
            $data_lead = [
                ...
                'applied_term'               => $lead->selected_term,
                'applied_payment'            => $lead->selected_payment,
                'applied_loan_total_amount'  => $lead->selected_total_credit,
                'applied_periodicity'        => $lead->periodicity,

...
class NewCreditStrategyTemplate implements TemplateInterface
{
    ...
    public function saveForm($request)
    {
        ...
        if ($history != null) {
            ...
            if ($percent_form == 100) {
                HistoryLog::move($credit->id, HistoryLog::KC_CHECK_UP_ACTION_REPORT, HistoryLog::KC_CHECK_UP_ACTION_REPORT, null, false);
    ...
    public function listStepReport($history_id)
    {
        ...
        try {
            ...
            $deadline1   = 'N/A';
            $deadline2   = \View::make('panel.module.view_dead_line', ['hour' => $hour, 'color_inf_credit' => $color_desition])->render();

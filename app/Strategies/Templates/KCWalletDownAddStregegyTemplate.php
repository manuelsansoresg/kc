...
class KCWalletDownAddStregegyTemplate implements TemplateInterface
{
    ...
    public function configFormStep1($id_rel, $history_id)
    {
        ...
        $format_withdraw_available = '<span class="text-primary"> '.format_price($withdraw_available).'<span>';
        $elements = array(
            1 => [
                'title_section' => null,
                'title' => 'Ordenante',
            ...
            3 => [
                ...
                'id_field' => 'transaction_type',
                'comment_admin' => null,
                'comment_webApp' =>  null,
                'placeholder' => '',
                'type' => 'hidden',
                'is_option_array' => null,
                'value' => 2,
                'is_required' => false,
                'is_disabled' => null
            ],
    ...
    public function saveForm($request)
    {
        ...
        //formulario etapa 1
        $transaction = Transaction::saveEdit($request, true);
    ...
    public function actionStep($history_id)
    {
        ...
        $subject1 = HistoryLog::$label_subject[66];
        ...
        $data[] = array(
            ...
            'advisor' => null,
            'options' => $option,
            'link' => '/panel/action-form/kc-down-wallet/'.$history->id.'/form?step=1'
        );
    ...
    public function listStep($history_id)
    {
        ...
        $percent_step1   = reduceDecimal((self::percentForm($history)));

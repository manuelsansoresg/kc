                                                ...
                                                <form method="post" id="frm-lead" action="">
                                                    ...
                                                    <div class="row gy-4">
                                                       ...
                                                       <div id="content-servicio-kc" style="display: none" class="mt-5">
                                                        ...
                                                        <input type="hidden" name="data[selected_payment]" id="selected_payment">
                                                        <input type="hidden" name="data[selected_total_credit]" id="selected_total_credit">
              ...
              <div class="modal-content">
                <form id="frm-modal-compra-cartera">
                    ...
                    <div class="modal-footer">
                        ...
                        <input type="hidden" name="data[lead_id]" id="lead_id_compra_cartera" value="{{ $lead_id }}">
                        <input type="hidden" name="data[client_person_id]" id="client_person_id_compra_cartera" value="{{ $clientPersonId }}">

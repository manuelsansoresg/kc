                                ...
                                <div class = "nk-block-des text-soft">
                                    <nav>
                                        <ul class = "breadcrumb">
                                            ...
                                            <li class = "breadcrumb-item active"><a href = "/panel/clients">Clientes</a>
                                            </li>
                                        </ul>
                                    </nav>
                                                ...
                                                <div class = "row gy-4">
                                                        ...
                                                        <div class = "form-group">
                                                            ...
                                                            <div class = "form-control-wrap">
                                                                <input type  = "text" class          = "form-control"
                                                                    name = "data[cellphone]" id = "client-cellphone">
                                                                <label id    = "cellphone-msg"
                                                        ...
                                                        <div class = "form-group">
                                                            ...
                                                            <div class = "form-control-wrap">
                                                                <input type  = "date" class = "form-control"
                                                                    name = "data[birth_date]" id = "client-birth_date">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class = "col-md-6">
                                                        <div class = "form-group">
                                                            ...
                                                            <div class = "form-control-wrap">
                                                                <input type  = "text" class    = "form-control"
                                                                    name = "data[bank_clabe]" id = "bank_clabe">
                                                                <label id    = "rfc-msg" class = "text-danger"></label>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class = "form-group">
                                                            ...
                                                            <div class = "form-control-wrap">
                                                                <input type  = "email" class     = "form-control"
                                                                    name = "data[email]" id = "client-email">
                                                        ...
                                                        <div class = "form-group">
                                                            ...
                                                            <div class = "form-control-wrap">
                                                                ...
                                                                <select class = "form-select js-select2"
                                                                    name = "data[agreement_id]" id = "client-agreement"
                                                                    data-search = "on" {{ $diabled }}>
                                                                    <option></option>
                                                    ...
                                                    <div class = "col-md-6">
                                                        <div class = "form-group">
                                                            ...
                                                            <div class = "form-control-wrap">
                                                                <input type  = "text" class = "form-control"
                                                                    name = "data[daily_income]"
                                                                    id = "client-daily_income">
                                                            </div>
                                                        </div>

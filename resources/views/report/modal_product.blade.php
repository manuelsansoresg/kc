            ...
            <div class="modal-body modal-body-lg">
                <form action="" id="frm-modal-product">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select select2multiple" multiple="multiple" name="products[]"   data-search="on" data-placeholder="Escribe para buscar">
                    ...
                    <div class="col-12 text-center mt-5">
                        <a href="#" class="btn btn-outline-primary" onclick="cancelModalProduct()">No veo mi crédito</a>
                        <a href="#" class="btn btn-outline-primary" onclick="continueModalProduct()">Continuar</a>
                    </div>
                </form>
            </div>
        </div>

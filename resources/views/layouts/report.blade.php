                                ...
                                <div class="col-md-6 pe-md-5 pe-lg-7 col-sm-9 mb-6 mb-lg-0" data-aos="fade-up"
                                    ...
                                    <div class="row align-items-center">
                                        <div class="col-12">
                                            ...
                                            <li class="d-flex mb-3 align-items-start"><span
                                                    class="material-symbols-rounded align-middle text-warning fs-4 me-3">check_circle</span>Financiera 2: $4,900 de interés.
                                                </li>
                                            <li class="d-flex mb-3 align-items-start"><span
                                                    class="material-symbols-rounded align-middle text-warning fs-4 me-3">check_circle</span>Financiera 3: $6,000 de interés.

                                                </li>
                                            <li class="d-flex mb-3 align-items-start"><span
                                                    class="material-symbols-rounded align-middle text-warning fs-4 me-3">check_circle</span>Financiera 4: $5,900 de interés.


                                                </li>
                                            <li class="d-flex mb-3 align-items-start"><span
                                                    class="material-symbols-rounded align-middle text-warning fs-4 me-3">check_circle</span>Financiera 5: $7,000 de interés.
        ...
        <div class="container py-9 py-lg-11">
            ...
            <div class="row">
                <div class="col-lg-4 mb-4 mb-lg-0" data-aos="fade-up" data-aos-delay="150">
                    <div class="card text-center py-5 px-4 py-lg-6 hover-lift shadow-lg border-0 rounded-4">
                        <div class="mb-4 size-60 rounded-circle overflow-hidden shadow-lg mx-auto">
                            <img src="/assets_report/img/avatars/male/1.jpg" class="img-fluid rounded-circle"
                                alt="">
                        </div>
                ...
                <div class="col-lg-4 mb-4 mb-lg-0" data-aos="fade-up" data-aos-delay="200">
                    <div class="card text-center py-5 px-4 py-lg-6 hover-lift shadow-lg border-0 rounded-4">
                        <div class="mb-4 size-60 rounded-circle overflow-hidden shadow-lg mx-auto">
                            <img src="/assets_report/img/avatars/female/1.jpg" class="img-fluid rounded-circle"
                                alt="">
                        </div>
                        <div class="text-warning d-flex align-items-center justify-content-center mb-3">
                            <span class="material-symbols-rounded">star</span>
                ...
                <div class="col-lg-4" data-aos="fade-up" data-aos-delay="250">
                    <div class="card text-center py-5 px-4 py-lg-6 hover-lift shadow-lg border-0 rounded-4">
                        <div class="mb-4 size-60 rounded-circle overflow-hidden shadow-lg mx-auto">
                            <img src="/assets_report/img/avatars/male/2.jpg" class="img-fluid rounded-circle"
                                alt="">
                        </div>
                        <div class="text-warning d-flex align-items-center justify-content-center mb-3">
                            <span class="material-symbols-rounded">star</span>

...
<head>
    ...
    <title>Ranking | EnftyMart - NFT Marketplace HTML Template</title>
    <!-- Favicon -->
                    ...
                    <table class="table mb-0 table-s1">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>3,593.91</td>
                                <td class="text-success">45.78%</td>
                            ...
                            <tr>
                                ...
                                <td>593.91</td>
                                <td class="text-success">23.78%</td>
                                <td class="text-danger">11.32%</td>
                                <td>5.5</td>
                                <td>3.5k</td>
                                <td>24.3k</td>
                            </tr>
                            <tr>
                                ...
                                <td>124.91</td>
                                <td class="text-success">22.78%</td>
                                <td class="text-danger">12.32%</td>
                                <td>4.5</td>
                                <td>4.5k</td>
                                <td>45.3k</td>
                            ...
                            <tr>
                                <th scope="row">
                                    <a href="#" class="d-flex align-items-center text-black">
                                        <span class="me-2 fs-13">5</span>
                                        <div class="avatar me-2">
                                            <img src="images/thumb/avatar-5.jpg" alt="">
                                        </div>
                                        <span>CoolThings</span>
                                    </a>
                                </th>
                                <td>456.91</td>
                                <td class="text-success">11.78%</td>

...
<head>
    ...
    <title>Redeem | EnftyMart - NFT Marketplace HTML Template</title>
    <!-- Favicon -->
                ...
                <div class="row">
                    <div class="col-lg-3">
                        <div class="sidebar-head d-flex flex-wrap align-items-center justify-content-between">
                            <h3 class="sidebar-head-title">Redeem Enfties</h3>
                        ...
                        <div class="sidebar sidebar-user-mobile">
                            ...
                            <div class="sidebar-widget">
                                <ul class="user-nav">
                                    ...
                                    <li class="active"><a href="redeem.html"><em class="ni ni-puzzle me-2"></em>Redeem</a></li>
                    ...
                    <div class="col-lg-9 ps-xl-5">
                        <div class="user-panel-title-box">
                            <h3>Redeem Enfties</h3>
                        </div><!-- end user-panel-title-box -->
                        <div class="profile-setting-panel-wrap">
                            <p class="fs-14 mb-3">Redemptions reward the top collectors of a particular artist by gifting them a nifty if a collector has a certain number of pieces from a particular collection on their account.</p>
                            <p class="fs-14 mb-4">To see if you are eligible, just select a redemption below!</p>
                            <h5 class="mb-1">Redeem Enfty</h5>
                            <p class="fs-14 mb-3">Select the project you would like to redeem</p>
                            <div class="row">
                                <div class="col-lg-5 col-md-6 form-choice-wrap">
                                    <select class="form-choice">
                                        <option selected="" value="0">Redemptions</option>
                                        <option value="1">Justin Roiland Open Edition</option>
                                        <option value="2">Blau Everything</option>
                                        <option value="3">Jon Burgerman’s Special Offer</option>
                                        <option value="4">Lans King's Capsule</option>
                                        <option value="5">Tommy Wilson Teams</option>
                                        <option value="6">Mad Dog Redemption</option>
                                    </select>
                                </div>
                            </div>
                            <p class="fs-14 mt-3">All 5 available Enfties for redemption have been claimed</p>

            ...
            <div class="hero-wrap hero-wrap-5">
                <div class="container">
                    <div class="row align-items-center flex-lg-row-reverse">
                        <div class="col-lg-5 ms-lg-auto col-md-9">
                                ...
                                <div class="card-body px-0 pb-0">
                                    ...
                                    <div class="card-price-wrap d-flex align-items-center justify-content-between">
                                        <div class="me-5 me-sm-2">
                                            ...
                                            <span class="card-price-number">0.32 ETH <span class="equivalance">11.00 USD</span>
                                            </span>
                                        </div>
                        ...
                        <div class="col-lg-6 col-md-9">
                            <div class="hero-content pt-lg-0 pb-0">
                                <h1 class="hero-title mb-4">Search, Explore and Sell your Specific artworks</h1>
                                <p class="hero-text mb-4 pb-1">If you are working with any type of Digital NFT Marketplace, NFT Consulting, and Development Firm for every industry then EnftyMart is the best choise to launch your website.</p>
                                ...
                                <div class="row g-gs">
                                    <div class="col-6 col-sm-4">
                                        <div class="count-item">
                                            <h3 class="count-title">259K+</h3>
                                            <span class="count-text small">NFTs Minted</span>
                                        </div>
                                    </div><!-- end col -->
                                    <div class="col-6 col-sm-4">
                                        <div class="count-item">
                                            <h3 class="count-title">$11M+</h3>
                                            <span class="count-text small">Trading Volume</span>
                                        </div>
                                    </div><!-- end col -->
                                    <div class="col-sm-4">
                                        <div class="count-item">
                                            <h3 class="count-title">24K+</h3>
                                            <span class="count-text small">Creative Creators</span>
                                        </div>
                                    </div><!-- end col -->
                                </div><!-- end row -->
                            </div><!-- hero-content -->
                ...
                <div class="row g-gs">
                    <div class="col-sm-6 col-lg-3">
                        <div class="card-hiw text-center card-hiw-s2">
                            ...
                            <span class="icon ni ni-wallet icon-md icon-rounded icon-wbg mx-auto mb-4 text-white bg-blue"></span>
                    ...
                    <div class="col-sm-6 col-lg-3">
                        <div class="card-hiw text-center card-hiw-s2">
                            ...
                            <span class="icon ni ni-file-text icon-md icon-rounded icon-wbg mx-auto mb-4 text-white bg-purple"></span>
                    ...
                    <div class="col-sm-6 col-lg-3">
                        <div class="card-hiw text-center card-hiw-s2">
                            <span class="card-hiw-number">4</span>
                            <span class="icon ni ni-money icon-md icon-rounded icon-wbg mx-auto mb-4 text-white bg-orange"></span>
        ...
        <section class="section-space trending-section bg-gray">
            <div class="container">
                <div class="section-head-md">
                    <div class="row align-items-center">
                        <div class="col-md-6 mb-3 mb-md-0">
                            <h6 class="mb-2 section-meta text-uppercase text-primary">NTFs Products</h6>
                            <h2>Trending Auctions</h2>
                        </div><!-- end col -->
                        <div class="col-md-6">
                            <p>Explore on the world's best NFT marketplace with our beautiful NFT products. We want to be a part of your smile.</p>
                        </div><!-- end col -->
                    </div><!-- end row -->
                ...
                <div class="text-center mt-4 mt-md-5">
                    <a href="explore-v3.html" class="btn-link btn-link-s1">View all auctions</a>
                </div>
            </div><!-- end container -->
        ...
        <section class="top-creator-section section-space">
            <div class="container">
                <div class="section-head-md">
                    <div class="row align-items-center">
                        <div class="col-md-6 mb-3 mb-md-0">
                            <h6 class="mb-2 section-meta text-uppercase text-primary">our Creators</h6>
                ...
                <div class="row g-gs">
                    <div class="col-lg-6">
                        <div class="card card-sell-buy card-full">
                            <div class="card-image">
                                <img src="images/thumb/buy.png" alt="">
                            </div>
                            <div class="card-body px-0">
                                <h4 class="mb-2">Buy NFT Products</h4>
                                <p class="mb-4">Purchase digital NFT products from the biggest directory.</p>
                                <a href="register.html" class="btn btn-sm btn-dark">Get Started</a>
                            </div>
                        </div><!-- end card -->
                    </div>
                    <div class="col-lg-6">
                        <div class="card card-sell-buy card-full">
                            <div class="card-image">
                                <img src="images/thumb/sell.png" alt="">
                            </div>
                            <div class="card-body px-0">
                                <h4 class="mb-2">Sell Your NFT Products</h4>
                                <p class="mb-4">Sell one of your NFT products to make a huge profit.</p>
                                <a href="create.html" class="btn btn-sm btn-dark">Start Selling</a>
                            </div>
                        </div><!-- end card -->
                    </div><!-- end col-lg-4 -->
                </div>

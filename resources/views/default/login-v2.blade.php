...
<head>
    ...
    <title>Login | EnftyMart - NFT Marketplace HTML Template</title>
    <!-- Favicon -->
...
<body>
    <div class="page-wrap">
        ...
        <section class="section-space-b pt-4 pt-md-5 mt-md-3">
            <div class="container">
                <div class="row ">
                    <div class="col-lg-8 col-xl-6 mx-auto">
                        <ul class="row g-gs nav nav-tabs nav-tabs-s2 justify-content-center" id="myTab" role="tablist">
                            <li class="nav-item col-sm-6 col-6" role="presentation">
                                <button class="nav-link active" id="meta-mask-tab" data-bs-toggle="tab" data-bs-target="#meta-mask" type="button" role="tab" aria-controls="meta-mask" aria-selected="true">
                                    <img src="images/thumb/metamask.svg" alt="" class="icon icon-svg icon-svg-md icon-svg-current">
                                    <span class="nav-link-title mt-2 mt-sm-3 d-block">MetaMask</span>
                                </button>
                            </li>
                            <li class="nav-item col-sm-6 col-6" role="presentation">
                                <button class="nav-link" id="wallet-connect-tab" data-bs-toggle="tab" data-bs-target="#wallet-connect" type="button" role="tab" aria-controls="wallet-connect" aria-selected="false">
                                    <img src="images/thumb/wallet-connect.svg" alt="" class="icon icon-svg icon-svg-md icon-svg-current">
                                    <span class="nav-link-title mt-2 mt-sm-3 d-block">Walletconnect</span>
                                </button>
                            </li>
                        </ul>
                        ...
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active" id="meta-mask" role="tabpanel" aria-labelledby="meta-mask-tab">
                                <div class="card-media card-media-s3 text-center">
                                    <div class="card-media-body">
                                        <h3 class="mb-4">Connect Your MetaMask Wallet</h3>
                                        <a href="login.html" class="btn btn-dark">Sign In</a>
                                        <p class="mt-3"><a href="#" target="_blank" class=" fs-13 btn-link fw-regular">Learn how to use MetaMask Wallet</a></p>
                                    </div>
                                </div><!-- end card-media -->
                            </div><!-- end tab-pane -->
                            <div class="tab-pane fade" id="wallet-connect" role="tabpanel" aria-labelledby="wallet-connect-tab">
                                <div class="card-media card-media-s3 text-center">
                                    <div class="card-media-body">
                                        <h3 class="mb-4">Connect Your Walletconnect Wallet</h3>
                                        <a href="login.html" class="btn btn-dark">Sign In</a>
                                        <p class="mt-3"><a href="#" target="_blank" class=" fs-13 btn-link fw-regular">Learn how to use Walletconnect Wallet</a></p>
                                    </div>
                                </div><!-- end card-media -->
                            </div><!-- end tab-pane -->
                        </div><!-- end tab-content -->

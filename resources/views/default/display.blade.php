...
<head>
    ...
    <title>Display | EnftyMart - NFT Marketplace HTML Template</title>
    <!-- Favicon -->
                ...
                <div class="row">
                    <div class="col-lg-3">
                        <div class="sidebar-head d-flex flex-wrap align-items-center justify-content-between">
                            <h3 class="sidebar-head-title">Display Enfties</h3>
                        ...
                        <div class="sidebar sidebar-user-mobile">
                            ...
                            <div class="sidebar-widget">
                                <ul class="user-nav">
                                    ...
                                    <li class="active"><a href="display.html"><em class="ni ni-camera me-2"></em>Display</a></li>
                    ...
                    <div class="col-lg-9 ps-xl-5">
                        <div class="user-panel-title-box">
                            <h3>Display Enfties</h3>
                        </div><!-- end user-panel-title-box -->
                        <div class="profile-setting-panel-wrap">
                            <p class="fs-14 mb-4">New to displays? Learn more <a href="#">here</a></p>
                            <h5 class="mb-3">Connect New Display</h5>
                            <form action="#">
                                <div class="row g-4">
                                    ...
                                    <div class="col-md-4 col-sm-6">
                                        <button class="btn btn-dark">Add Display</button>
                                    </div>
                                </div>
                            </form>
                            <hr class="my-4">
                            <h5 class="mb-3">Your Displays</h5>
                            <a href="#" class="btn btn-outline-dark">Display external Enfties</a>

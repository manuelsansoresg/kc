...
<head>
    ...
    <title>Create Item | EnftyMart - NFT Marketplace HTML Template</title>
    <!-- Favicon -->
...
<body>
    <div class="page-wrap">
        ...
        <section class="create-section bg-pattern section-space-b pt-70">
            <div class="container">
                <div class="row">
                    <div class="col-lg-6 mx-auto">
                        <div class="create-content-box">
                            <div class="section-head-sm">
                                <a href="/" class="btn-link fw-semibold"><em class="ni ni-arrow-left"></em> Go Back</a>
                                <h1 class="mt-2 mb-3">Create collectible</h1>
                            ...
                            <div class="row g-gs">
                                <div class="col-sm-6 col-6">
                                    <a href="create-single.html" class="card text-center">
                                ...
                                <div class="col-sm-6 col-6">
                                    <a href="create-multiple.html" class="card text-center">
                                        <div class="card-body card-body-s1 d-block">
                            ...
                            <p class="mt-4 mt-lg-5">We do not own your private keys and cannot access your funds without your confirmation</p>

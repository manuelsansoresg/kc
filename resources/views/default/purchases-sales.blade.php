...
<head>
    ...
    <title>Purchases & Sales | EnftyMart - NFT Marketplace HTML Template</title>
    <!-- Favicon -->
...
<body>
    <div class="page-wrap">
        <header class="header-section has-header-main">
            <div class="header-main is-sticky">
                <div class="container">
                    <div class="header-wrap">
                        ...
                        <div class="header-mobile-action">
                            ...
                            <div class="header-mobile-user-menu dropdown me-2">
                                ...
                                <ul class="dropdown-menu card-generic card-generic-s3 dropdown-menu-end mt-2">
                                    ...
                                    <li><a class="dropdown-item card-generic-item" href="profile.html"><em class="ni ni-user me-2"></em> Profile</a></li>
                                    <li><a class="dropdown-item card-generic-item" href="offers.html"><em class="ni ni-dashboard me-2"></em> Dashboard</a></li>
                                    <li><a class="dropdown-item card-generic-item" href="account.html"><em class="ni ni-setting me-2"></em> Account Settings</a></li>
                                    <li><a class="dropdown-item card-generic-item" href="contact.html"><em class="ni ni-question-alt me-2"></em> Help center</a></li>
                                    ...
                                    <li><a class="dropdown-item card-generic-item" href="/"><em class="ni ni-power me-2"></em> Logout</a></li>
                                </ul>
                            </div><!-- end header-mobile-user-menu -->
                        ...
                        <div class="header-search-form header-search-form-s2">
                            <input type="search" class="form-control form-control-s1" placeholder="Search item here...">
                        </div>
                        <nav class="header-menu menu nav">
                            ...
                            <ul class="menu-btns menu-btns-2">
                                <li class="d-none d-lg-inline-block"><a href="wallet.html" class="icon-btn icon-btn-s1" title="Wallet"><em class="ni ni-wallet"></em></a></li>
                                ...
                                <li class="d-lg-none"><a href="wallet.html" class="btn btn-lg btn-dark">Connect Wallet</a></li>
                            </ul>
                        </nav><!-- .header-menu -->
            ...
            <div class="hero-wrap sub-header" style="background-image: url('images/thumb/bread-bg-2.jpg')">
                    ...
                    <div class="hero-content py-0 d-flex align-items-center">
                        ...
                        <div class="author-hero-content-wrap d-flex flex-wrap justify-content-between ms-3 flex-grow-1">
                            <div class="author-hero-content me-3">
                                <h4 class="hero-author-title mb-1 text-white">Kamran Ahmed</h4>
                                <p class="hero-author-username mb-1 text-white">@kamran_76</p>
                            </div><!-- end author-hero-content -->
                            <div class="hero-action-wrap d-flex align-items-center my-2">
                                <a href="account.html" class="btn btn-light">Edit Profile</a>
                            </div>
                ...
                <div class="row">
                    <div class="col-lg-3">
                        <div class="sidebar-head d-flex flex-wrap align-items-center justify-content-between">
                            <h3 class="sidebar-head-title">Sales & Purchase</h3>
                        ...
                        <div class="sidebar sidebar-user-mobile">
                            ...
                            <div class="sidebar-widget">
                                <ul class="user-nav">
                                    <li><a href="offers.html"><em class="ni ni-gift me-2"></em>My Offers</a></li>
                                    <li><a href="activity-2.html"><em class="ni ni-file-text me-2"></em>Activity</a></li>
                                    <li class="active"><a href="purchases-sales.html"><em class="ni ni-money me-2"></em>Sales / Purchase</a></li>
                                    <li><a href="transactions.html"><em class="ni ni-exchange me-2"></em>Transactions</a></li>
                                    <li><a href="display.html"><em class="ni ni-camera me-2"></em>Display</a></li>
                                    <li><a href="redeem.html"><em class="ni ni-puzzle me-2"></em>Redeem</a></li>
                                    <li><a href="deposit.html"><em class="ni ni-download-cloud me-2"></em>Deposit Enfties</a></li>
                                </ul>
                                    ...
                                    <div class="profile-setting-panel">
                                        <div class="history-panel">
                                            <span class="history-panel-left">
                                                ...
                                                <span>You bought <a href="product-details-v1.html" class="btn-link fw-medium">Serpent #76/140</a> from <a href="author.html" class="btn-link fw-medium">Alex</a> for <span class="fw-medium">$250.00</span></span>
                                            </span>
                                            <span class="history-panel-right">4d ago</span>
                                        </div><!-- end history-panel -->
                                        <div class="history-panel">
                                            <span class="history-panel-left">
                                                <em class="ni ni-money me-1"></em>
                                                <span>You bought <a href="product-details-v1.html" class="btn-link fw-medium">Afterburn</a> from <a href="author.html" class="btn-link fw-medium">Alex</a> for <span class="fw-medium">$34.00</span></span>
                                            </span>
                                            <span class="history-panel-right">5d ago</span>
                                        </div><!-- end history-panel -->
                                        <div class="history-panel">
                                            <span class="history-panel-left">
                                                <em class="ni ni-money me-1"></em>
                                                <span>You bought <a href="product-details-v1.html" class="btn-link fw-medium">Dance or Die</a> from <a href="author.html" class="btn-link fw-medium">Alex</a> for <span class="fw-medium">$13.00</span></span>
                                            </span>
                                            <span class="history-panel-right">5d ago</span>
                                        </div><!-- end history-panel -->
                                        <div class="history-panel">
                                            <span class="history-panel-left">
                                                <em class="ni ni-money me-1"></em>
                                                <span>You bought <a href="product-details-v1.html" class="btn-link fw-medium">Green Parrot Island</a> from <a href="author.html" class="btn-link fw-medium">Alex</a> for <span class="fw-medium">$15.00</span></span>
                                            </span>
                                            <span class="history-panel-right">5d ago</span>
                                        </div><!-- end history-panel -->
                                        <div class="history-panel">
                                            <span class="history-panel-left">
                                                <em class="ni ni-money me-1"></em>
                                                <span>You bought <a href="product-details-v1.html" class="btn-link fw-medium">Lavish</a> from <a href="author.html" class="btn-link fw-medium">Alex</a> for <span class="fw-medium">$34.00</span></span>
                                            </span>
                                            <span class="history-panel-right">6d ago</span>
                                        </div><!-- end history-panel -->
                                        <div class="history-panel">
                                            <span class="history-panel-left">
                                                <em class="ni ni-money me-1"></em>
                                                <span>You bought <a href="product-details-v1.html" class="btn-link fw-medium">Karma Chameleon</a> from <a href="author.html" class="btn-link fw-medium">Alex</a> for <span class="fw-medium">$32.00</span></span>
                                            </span>
                                            <span class="history-panel-right">6d ago</span>
                                        </div><!-- end history-panel -->
                                        <div class="history-panel">
                                            <span class="history-panel-left">
                                                <em class="ni ni-money me-1"></em>
                                                <span>You bought <a href="product-details-v1.html" class="btn-link fw-medium">Le Anime</a> from <a href="author.html" class="btn-link fw-medium">Alex</a> for <span class="fw-medium">$12.00</span></span>
                                            </span>
                                            <span class="history-panel-right">7d ago</span>
                                        </div><!-- end history-panel -->
                                        <div class="history-panel">
                                            <span class="history-panel-left">
                                                <em class="ni ni-money me-1"></em>
                                                <span>You bought <a href="product-details-v1.html" class="btn-link fw-medium">Lady Robot #62</a> from <a href="author.html" class="btn-link fw-medium">Alex</a> for <span class="fw-medium">$20.00</span></span>
                                            </span>
                                            <span class="history-panel-right">7d ago</span>
                                        </div><!-- end history-panel -->
                                        <div class="history-panel">
                                            <span class="history-panel-left">
                                                <em class="ni ni-money me-1"></em>
                                                <span>You bought <a href="product-details-v1.html" class="btn-link fw-medium">Creature #8477</a> from <a href="author.html" class="btn-link fw-medium">Alex</a> for <span class="fw-medium">$30.00</span></span>
                                            </span>
                                            <span class="history-panel-right">8d ago</span>
                                        </div><!-- end history-panel -->
                                        <div class="history-panel">
                                            <span class="history-panel-left">
                                                <em class="ni ni-money me-1"></em>
                                                <span>You bought <a href="product-details-v1.html" class="btn-link fw-medium">Gold #422/477</a> from <a href="author.html" class="btn-link fw-medium">Alex</a> for <span class="fw-medium">$50.00</span></span>
                                            </span>
                                            <span class="history-panel-right">9d ago</span>
                                        </div><!-- end history-panel -->
                                ...
                                <div class="tab-pane fade" id="sales" role="tabpanel" aria-labelledby="sales-tab">
                                    <div class="profile-setting-panel">
                                        <div class="history-panel">
                                            <span class="history-panel-left">
                                                <em class="ni ni-money me-1"></em>
                                                <span><a href="author.html" class="btn-link fw-medium">David</a> bought <a href="product-details-v1.html" class="btn-link fw-medium">Lady Robot #62</a> from You for <span class="fw-medium">$20.00</span></span>
                                            </span>
                                            <span class="history-panel-right">7d ago</span>
                                        </div><!-- end history-panel -->
                                        <div class="history-panel">
                                            <span class="history-panel-left">
                                                <em class="ni ni-money me-1"></em>
                                                <span><a href="author.html" class="btn-link fw-medium">Rob</a> bought <a href="product-details-v1.html" class="btn-link fw-medium">Creature #8477</a> from You for <span class="fw-medium">$30.00</span></span>
                                            </span>
                                            <span class="history-panel-right">8d ago</span>
                                        </div><!-- end history-panel -->
                                        <div class="history-panel">
                                            <span class="history-panel-left">
                                                <em class="ni ni-money me-1"></em>
                                                <span><a href="author.html" class="btn-link fw-medium">Jared Liner</a> bought <a href="product-details-v1.html" class="btn-link fw-medium">Gold #422/477</a> from You for <span class="fw-medium">$50.00</span></span>
                                            </span>
                                            <span class="history-panel-right">9d ago</span>
                                        </div><!-- end history-panel -->
                                        <div class="history-panel">
                                            <span class="history-panel-left">
                                                <em class="ni ni-money me-1"></em>
                                                <span><a href="author.html" class="btn-link fw-medium">Antonio</a> bought <a href="product-details-v1.html" class="btn-link fw-medium">Serpent #76/140</a> from You for <span class="fw-medium">$250.00</span></span>
                                            </span>
                                            <span class="history-panel-right">4d ago</span>
                                        </div><!-- end history-panel -->
                                        <div class="history-panel">
                                            <span class="history-panel-left">
                                                <em class="ni ni-money me-1"></em>
                                                <span><a href="author.html" class="btn-link fw-medium">Jhon</a> bought <a href="product-details-v1.html" class="btn-link fw-medium">Afterburn</a> from You for <span class="fw-medium">$34.00</span></span>
                                            </span>
                                            <span class="history-panel-right">5d ago</span>
                                        </div><!-- end history-panel -->
                                        <div class="history-panel">
                                            <span class="history-panel-left">
                                                <em class="ni ni-money me-1"></em>
                                                <span><a href="author.html" class="btn-link fw-medium">Kevin Martin</a> bought <a href="product-details-v1.html" class="btn-link fw-medium">Dance or Die</a> from You for <span class="fw-medium">$13.00</span></span>
                                            </span>
                                            <span class="history-panel-right">5d ago</span>
                                        </div><!-- end history-panel -->
                                        <div class="history-panel">
                                            <span class="history-panel-left">
                                                <em class="ni ni-money me-1"></em>
                                                <span><a href="author.html" class="btn-link fw-medium">Once</a> bought <a href="product-details-v1.html" class="btn-link fw-medium">Green Parrot Island</a> from You for <span class="fw-medium">$15.00</span></span>
                                            </span>
                                            <span class="history-panel-right">5d ago</span>
                                        </div><!-- end history-panel -->
                                        <div class="history-panel">
                                            <span class="history-panel-left">
                                                <em class="ni ni-money me-1"></em>
                                                <span><a href="author.html" class="btn-link fw-medium">Kamran</a> bought <a href="product-details-v1.html" class="btn-link fw-medium">Lavish</a> from You for <span class="fw-medium">$34.00</span></span>
                                            </span>
                                            <span class="history-panel-right">6d ago</span>
                                        </div><!-- end history-panel -->
                                        <div class="history-panel">
                                            <span class="history-panel-left">
                                                <em class="ni ni-money me-1"></em>
                                                <span><a href="author.html" class="btn-link fw-medium">Abe</a> bought <a href="product-details-v1.html" class="btn-link fw-medium">Karma Chameleon</a> from You for <span class="fw-medium">$32.00</span></span>
                                            </span>
                                            <span class="history-panel-right">6d ago</span>
                                        </div><!-- end history-panel -->
                                        <div class="history-panel">
                                            <span class="history-panel-left">
                                                <em class="ni ni-money me-1"></em>
                                                <span><a href="author.html" class="btn-link fw-medium">Robert</a> bought <a href="product-details-v1.html" class="btn-link fw-medium">Le Anime</a> from You for <span class="fw-medium">$12.00</span></span>
                                            </span>
                                            <span class="history-panel-right">7d ago</span>
                                        </div><!-- end history-panel -->
                                    </div><!-- end profile-setting-panel -->

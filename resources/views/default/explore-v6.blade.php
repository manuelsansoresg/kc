...
<head>
    ...
    <title>Explore | EnftyMart - NFT Marketplace HTML Template</title>
    <!-- Favicon -->
...
<body>
    <div class="page-wrap">
        ...
        <section class="explore-section pt-lg-4">
            <div class="container">
                <div class="filter-box d-flex flex-wrap align-items-center justify-content-between pb-5 pb-md-4">
                    ...
                    <div class="button-group filter-button-group">
                        ...
                        <button class="button" data-filter=".collectibles">Collectibles</button>
                        <button class="button" data-filter=".games">Games</button>
                    </div>
                </div><!-- end filter-box -->
                <div class="filter-container row g-gs">
                    <div class="col-xl-3 col-lg-4 col-sm-6 filter-item artworks">
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6 filter-item music">
                        <div class="card card-full card-s3">
                            <div class="card-author d-flex align-items-center justify-content-between pb-3">
                                <div class="d-flex align-items-center">
                                    <a href="author.html" class="avatar me-1">
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6 filter-item collectibles">
                        <div class="card card-full card-s3">
                            <div class="card-author d-flex align-items-center justify-content-between pb-3">
                                <div class="d-flex align-items-center">
                                    <a href="author.html" class="avatar me-1">
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6 filter-item games">
                        <div class="card card-full card-s3">
                            <div class="card-author d-flex align-items-center justify-content-between pb-3">
                                <div class="d-flex align-items-center">
                                    <a href="author.html" class="avatar me-1">
                        ...
                        <div class="card-creator-v card-creator-v-wbg card-full">
                            <div class="card-body">
                                ...
                                <div class="card-creator-info">
                                    <a href="author.html" class="avatar flex-shrink-0">
                                        <img src="images/thumb/avatar.jpg" alt="avatar">
                                    </a>
        ...
        <section class="collection-section section-space">
            <div class="container">
                ...
                }' data-loop="true" data-autoplay="false" data-speed="800" data-centeredslides="false">
                    <!-- Additional required wrapper -->
                    <div class="swiper-wrapper">
                        <!-- Slides -->
                        <div class="swiper-slide h-auto">
                            <a href="explore.html" class="card card-full card-collection">
                                <img src="images/thumb/art-5.jpg" class="card-img-top" alt="birds art image">
                                <div class="card-body card-body-s1">
                                    <div class="avatar avatar-1">
                                        <img src="images/thumb/avatar.jpg" alt="avatar" class="rounded-circle">
                                    </div><!-- end avatar -->
                                    <h4 class="card-title mt-4 mb-2 pt-1 card-title-effect">Crappy Dogecoin</h4>
                                    <p class="fw-semibold text-secondary">$26,220</p>
                                </div><!-- end card-body -->
                            </a><!-- end card -->
                        </div><!-- end swiper-slider -->
                        <div class="swiper-slide h-auto">
                            <a href="explore.html" class="card card-full card-collection">
                                <img src="images/thumb/art-6.jpg" class="card-img-top" alt="birds art image">
                                <div class="card-body card-body-s1">
                                    <div class="avatar avatar-1">
                                        <img src="images/thumb/avatar-2.jpg" alt="avatar" class="rounded-circle">
                                    </div><!-- end avatar -->
                                    <h4 class="card-title mt-4 mb-2 pt-1 card-title-effect">Savage Dogs</h4>
                                    <p class="fw-semibold text-secondary">$24,497</p>
                                </div><!-- end card-body -->
                            </a><!-- end card -->
                        </div><!-- end swiper-slider -->
                        <div class="swiper-slide h-auto">
                            <a href="explore.html" class="card card-full card-collection">
                                <img src="images/thumb/art-7.jpg" class="card-img-top" alt="birds art image">
                                <div class="card-body card-body-s1">
                                    <div class="avatar avatar-1">
                                        <img src="images/thumb/avatar-3.jpg" alt="avatar" class="rounded-circle">
                                    </div><!-- end avatar -->
                                    <h4 class="card-title mt-4 mb-2 pt-1 card-title-effect">Crappy Dogecoin</h4>
                                    <p class="fw-semibold text-secondary">$26,220</p>
                                </div><!-- end card-body -->
                        ...
                        <div class="swiper-slide h-auto">
                            <a href="explore.html" class="card card-full card-collection">
                                <img src="images/thumb/art-8.jpg" class="card-img-top" alt="birds art image">
                                <div class="card-body card-body-s1">
                                    <div class="avatar avatar-1">
                                        <img src="images/thumb/avatar-4.jpg" alt="avatar" class="rounded-circle">
                                    </div><!-- end avatar -->
                                    <h4 class="card-title mt-4 mb-2 pt-1 card-title-effect">Crypto Krills</h4>
                                    <p class="fw-semibold text-secondary">$11,356</p>
                                </div><!-- end card-body -->
                            </a><!-- end card -->
                        </div><!-- end swiper-slider -->
                        <div class="swiper-slide h-auto">
                            <a href="explore.html" class="card card-full card-collection">
                                <img src="images/thumb/art-9.jpg" class="card-img-top" alt="birds art image">
                                <div class="card-body card-body-s1">
                                    <div class="avatar avatar-1">
                                        <img src="images/thumb/avatar-5.jpg" alt="avatar" class="rounded-circle">
                                    </div><!-- end avatar -->
                                    <h4 class="card-title mt-4 mb-2 pt-1 card-title-effect">Chibi Doge</h4>
                                    <p class="fw-semibold text-secondary">$4,234</p>
                                </div><!-- end card-body -->
                            </a><!-- end card -->
                        </div><!-- end swiper-slider -->

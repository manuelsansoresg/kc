...
<head>
    ...
    <title>About Us | EnftyMart - NFT Marketplace HTML Template</title>
    <!-- Favicon -->
...
<body>
    <div class="page-wrap">
            ...
            <div class="container">
                <div class="row g-gs">
                    ...
                    <div class="col-md-4 col-xl-2 col-sm-4 col-6">
                        <div class="card card-counter text-center">
                            <div class="card-body card-body-s1">
                                <img src="images/thumb/icon-collections.svg" alt="" class="mb-3">
                                <h3 class="mb-1">1M</h3>
                                <p>Collections</p>
                            </div><!-- end card-body -->
                        </div><!-- end card-->
                    ...
                    <div class="col-md-4 col-xl-2 col-sm-4 col-6">
                        <div class="card card-counter text-center">
                            <div class="card-body card-body-s1">
                                <img src="images/thumb/icon-money.svg" alt="" class="mb-3">
                                <h3 class="mb-1">$2B+</h3>
                                <p>Volume</p>
                            </div><!-- end card-body -->
                        </div><!-- end card-->
        ...
        <section class="story-section section-space-b">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-6 mb-5 mb-lg-0">
                        <img src="images/thumb/about-img.jpg" alt="" class="w-100 rounded-3">
                    </div><!-- end col-lg-6 -->
                    <div class="col-lg-6 ps-xl-5">
                        <div class="about-content-wrap">
                            <h2 class="mb-3">About the EnftyMart</h2>
                            <p class="lead">EnftyMart was founded with a very simple mission - to make Enfties accessible to everyone</p>
                            ...
                            <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Minus, quasi consectetur. Et delectus minus saepe cumque qui harum! Aperiam, dolorem itaque</p>
                            <p>Today, <strong>we’re proud to remain the largest general marketplace for user-owned digital items</strong>, supporting multiple blockchains, with the broadest set of categories</p>
                        </div>
                    </div><!-- end col-lg-6 -->
                </div><!-- end row -->
            </div><!-- end contaiern -->
        </section><!-- end story-section -->
        <section class="brand-section section-space bg-gray">
            <div class="container">
                <div class="section-head text-center">
                    <h2 class="mb-3">Backed by top firms & industry leaders</h2>
        ...
        <section class="team-section section-space">
            <div class="container">
                <div class="section-head text-center">
                    <h2 class="mb-3">with some of the most forward-thinking angels</h2>
                ...
                <div class="row g-gs">
                    <div class="col-6 col-md-6 col-lg-4">
                        <div class="team-item text-center">
                            ...
                            <h4 class="mb-1">Jessica brown</h4>
                            <p class="fs-13">Co-founder of Scalar</p>
                        </div>
                    </div><!-- end col -->
                    <div class="col-6 col-md-6 col-lg-4">
                        <div class="team-item text-center">
                            <img src="images/client/b.jpg" alt="" class="team-item-img mb-4">
                            <h4 class="mb-1">Tim Ferris</h4>
                            <p class="fs-13">Entrepreneur</p>
                        </div>
                    </div><!-- end col -->
                    <div class="col-6 col-md-6 col-lg-4">
                        <div class="team-item text-center">
                            <img src="images/client/c.jpg" alt="" class="team-item-img mb-4">
                            <h4 class="mb-1">Belinda Johnson</h4>
                            <p class="fs-13">Attorney of Airbnb</p>
                        </div>
                    </div><!-- end col -->
                    <div class="col-6 col-md-6 col-lg-4">
                        <div class="team-item text-center">
                            <img src="images/client/d.jpg" alt="" class="team-item-img mb-4">
                            <h4 class="mb-1">Justin Kan</h4>
                            <p class="fs-13">Co-founder of Twitch</p>
                        </div>
                    </div><!-- end col -->
                    <div class="col-6 col-md-6 col-lg-4">
                        <div class="team-item text-center">
                            <img src="images/client/e.jpg" alt="" class="team-item-img mb-4">
                            <h4 class="mb-1">Alexis Ohanian</h4>
                            <p class="fs-13">Co-founder of Reddit</p>
                        </div>
                    </div><!-- end col -->
                    <div class="col-6 col-md-6 col-lg-4">
                        <div class="team-item text-center">
                            <img src="images/client/f.jpg" alt="" class="team-item-img mb-4">
                            <h4 class="mb-1">Balaji Srinivisan</h4>
                            <p class="fs-13">Entrepreneur</p>
                        </div>
                    </div><!-- end col -->
                </div><!-- end row -->
        ...
        <section class="blog-section section-space-b">
            <div class="container">
                <div class="section-head text-center">
                    <h2 class="mb-3">You might have read about us in the news</h2>

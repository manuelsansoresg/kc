...
<head>
    ...
    <title>Activity v2 | EnftyMart - NFT Marketplace HTML Template</title>
    <!-- Favicon -->
                ...
                <div class="row">
                    <div class="col-lg-3">
                        <div class="sidebar-head d-flex flex-wrap align-items-center justify-content-between">
                            <h3 class="sidebar-head-title">Activity</h3>
                        ...
                        <div class="sidebar sidebar-user-mobile">
                            ...
                            <div class="sidebar-widget">
                                <ul class="user-nav">
                                    ...
                                    <li class="active"><a href="activity-2.html"><em class="ni ni-file-text me-2"></em>Activity</a></li>
                    ...
                    <div class="col-lg-9 ps-xl-5">
                        ...
                        <div class="profile-setting-panel-wrap pt-2">
                            <ul class="nav nav-tabs nav-tabs-s3 mb-2" id="myTab" role="tablist">
                                ...
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="bidding-tab" data-bs-toggle="tab" data-bs-target="#bidding" type="button" role="tab" aria-controls="bidding" aria-selected="false"> Bidding </button>
                                </li>
                                <li class="nav-item" role="presentation">
                                    ...
                                    <div class="activity-tab-wrap">
                                        <div class="card card-creator-s1 mb-4">
                                            <div class="card-body d-flex align-items-center">
                                                ...
                                                <div class="flex-grow-1 ms-2">
                                                    <h6 class="card-s1-title mb-1">Monica Lucas</h6>
                                                    <p class="card-s1-text">Started following <a href="author.html">Gayle Hicks</a></p>
                                                    <p class="card-s1-text">10/07/2021, 12:40</p>
                                                </div>
                                            </div>
                                        </div><!-- end card -->
                                        <div class="card card-creator-s1 mb-4">
                                            <div class="card-body d-flex align-items-center">
                                                ...
                                                <div class="flex-grow-1 ms-2">
                                                    <h6 class="card-s1-title mb-1">Deep Sea Phantasy</h6>
                                                    <p class="card-s1-text">Bid placed by <a href="author.html">Stacy Long</a> for 0.001 ETH</p>
                                                    <p class="card-s1-text">12/05/2021, 11:34</p>
                                                </div>
                                            </div>
                                        </div><!-- end card -->
                                        <div class="card card-creator-s1 mb-4">
                                            <div class="card-body d-flex align-items-center">
                                                ...
                                                <div class="flex-grow-1 ms-2">
                                                    <h6 class="card-s1-title mb-1">Cute Astronout</h6>
                                                    <p class="card-s1-text">Purchased by <a href="author.html">Nicholas Daniels</a> for 0.145 ETH</p>
                                                    <p class="card-s1-text">12/05/2021, 11:34</p>
                                                </div>
                                            </div>
                                        </div><!-- end card -->
                                        <div class="card card-creator-s1 mb-4">
                                            <div class="card-body d-flex align-items-center">
                                                ...
                                                <div class="flex-grow-1 ms-2">
                                                    <h6 class="card-s1-title mb-1">Mamie Barnett</h6>
                                                    <p class="card-s1-text">Started following <a href="author.html">Nicholas Daniels</a></p>
                                                    <p class="card-s1-text">11/05/2021, 11:34</p>
                                                </div>
                                            </div>
                                        </div><!-- end card -->
                                        <div class="card card-creator-s1 mb-4">
                                            <div class="card-body d-flex align-items-center">
                                                ...
                                                <div class="flex-grow-1 ms-2">
                                                    <h6 class="card-s1-title mb-1">Alex Smith</h6>
                                                    <p class="card-s1-text">Started following <a href="author.html">Kevin Martin</a></p>
                                                    <p class="card-s1-text">14/04/2021, 11:34</p>
                                                </div>
                                            </div>
                                        </div><!-- end card -->
                                        <div class="card card-creator-s1 mb-4">
                                            <div class="card-body d-flex align-items-center">
                                                <div class="avatar avatar-1 flex-shrink-0">
                                                    <img src="images/thumb/avatar-6.jpg" alt="avatar" class="rounded-circle">
                                                </div>
                                                <div class="flex-grow-1 ms-2">
                                                    <h6 class="card-s1-title mb-1">Jhonathan Doe</h6>
                                                    <p class="card-s1-text">Bid placed by <a href="author.html">Evan You</a> for 0.013 ETH</p>
                                                    <p class="card-s1-text">14/04/2021, 10:34</p>
                                                </div>
                                            </div>
                                        </div><!-- end card -->
                                        <div class="card card-creator-s1 mb-4">
                                            <div class="card-body d-flex align-items-center">
                                                <div class="avatar avatar-1 flex-shrink-0">
                                                    <img src="images/thumb/avatar-7.jpg" alt="avatar" class="rounded-circle">
                                                </div>
                                                <div class="flex-grow-1 ms-2">
                                                    <h6 class="card-s1-title mb-1">Jhon Abraham</h6>
                                                    <p class="card-s1-text">Purchased by <a href="author.html">David Hardson</a> for 0.212 ETH</p>
                                                    <p class="card-s1-text">14/04/2021, 11:30</p>
                                                </div>
                                            </div>
                                        </div><!-- end card -->

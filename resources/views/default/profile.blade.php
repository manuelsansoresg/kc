...
<head>
    ...
    <title>My Profile | EnftyMart - NFT Marketplace HTML Template</title>
    <!-- Favicon -->
                    ...
                    <div class="col-xl-9 ps-xl-4">
                        <div class="author-items-wrap">
                            ...
                            <div class="text-center mt-5">
                                <a href="#" class="btn-link btn-link-s1">Load More</a>
                            </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-body text-center">
                    ...
                    <h4 class="modal-tilte mb-2">Your item will be deleted permanently!</h4>
                    <p class="modal-text">Are you sure you want to delete your item?</p>
                </div><!-- end modal-body -->

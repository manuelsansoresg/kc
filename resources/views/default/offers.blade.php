...
<head>
    ...
    <title>Offers | EnftyMart - NFT Marketplace HTML Template</title>
    <!-- Favicon -->
                ...
                <div class="row">
                    <div class="col-lg-3">
                        <div class="sidebar-head d-flex flex-wrap align-items-center justify-content-between">
                            <h3 class="sidebar-head-title">Enfty Dashboard</h3>
                        ...
                        <div class="sidebar sidebar-user-mobile">
                            ...
                            <div class="sidebar-widget">
                                <ul class="user-nav">
                                    <li class="active"><a href="offers.html"><em class="ni ni-gift me-2"></em>My Offers</a></li>
                                    <li><a href="activity-2.html"><em class="ni ni-file-text me-2"></em>Activity</a></li>
                                    <li><a href="purchases-sales.html"><em class="ni ni-money me-2"></em>Sales / Purchase</a></li>
                    ...
                    <div class="col-lg-9 ps-xl-5">
                        <div class="user-panel-title-box">
                            <h3>Enfty Dashboard</h3>
                        </div><!-- end user-panel-title-box -->
                        <div class="profile-setting-panel-wrap">
                            <ul class="nav nav-tabs nav-tabs-s1 nav-tabs-mobile-size" id="myTab" role="tablist">
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link active" id="offers-receive-tab" data-bs-toggle="tab" data-bs-target="#offers-receive" type="button" role="tab" aria-controls="offers-receive" aria-selected="true"> Received Offers (30) </button>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="offers-made-tab" data-bs-toggle="tab" data-bs-target="#offers-made" type="button" role="tab" aria-controls="offers-made" aria-selected="false"> Offers Made (10) </button>
                                </li>
                            </ul>
                            <div class="tab-content mt-4" id="myTabContent">
                                <div class="tab-pane fade show active" id="offers-receive" role="tabpanel" aria-labelledby="offers-receive-tab">
                                    <div class="profile-setting-panel">
                                        <div class="alert alert-danger d-flex mb-4" role="alert">
                                            ...
                                            <p class="fs-14">In order to sell NFTs on EnftyMart, you must <a href="seller-settings.html" class="btn-link">become an authorized seller.</a> It only takes a few minutes!</p>
                                        </div><!-- end alert -->
                                        <h3 class="mb-1">Your Received Offers:</h3>
                                        <p class="mb-4 fs-14">Showing 1 to 6 of 30 entries</p>
                                        <div class="row g-gs">
                                            <div class="col-xl-6">
                                                <div class="card card-full">
                                                    <div class="card-body card-body-s1">
                                                        <p class="mb-3 fs-13 mb-4">Offer received 13m ago</p>
                                                        <div class="card-media mb-3">
                                                            <div class="card-media-img flex-shrink-0">
                                                                <img src="images/thumb/small-img.jpg" alt="media image">
                                                            </div><!-- card-media-img -->
                                                            <div class="card-media-body">
                                                                <h4><a href="product-details-v1.html">Eternal Zen</a></h4>
                                                                <p class="fw-medium fs-14">Contact Address</p>
                                                                <p class="fs-15">08 W 36th St, New York, NY 10001</p>
                                                            </div><!-- end card-media-body -->
                                                        </div><!-- end card-media -->
                                                        <div class="card-media mb-3">
                                                            <div class="card-media-body">
                                                                <span class="fw-medium fs-13">Get Offer</span>
                                                                <p class="fw-medium text-black fs-14">$1,800.00</p>
                                                            </div>
                                                            <div class="card-media-body">
                                                                <span class="fw-medium fs-13">Payment Methods</span>
                                                                <p class="fw-medium text-black fs-14">Visa ending in 9720</p>
                                                            </div>
                                                        </div><!-- end d-flex -->
                                                        <ul class="btns-group">
                                                            <li><a href="#" class="btn-link flex-grow-1 fw-medium fs-13 text-success">Accept Offer</a></li>
                                                            <li><a href="#" class="btn-link flex-grow-1 fw-medium fs-13 text-danger">Cancel Offer</a></li>
                                                        </ul>
                                                    </div><!-- end card-body -->
                                                </div><!-- end card -->
                                            </div><!-- end col -->
                                            <div class="col-xl-6">
                                                <div class="card card-full">
                                                    <div class="card-body card-body-s1">
                                                        <p class="mb-3 fs-13 mb-4">Offer received 17m ago</p>
                                                        <div class="card-media mb-3">
                                                            <div class="card-media-img flex-shrink-0">
                                                                <img src="images/thumb/small-img-2.jpg" alt="media image">
                                                            </div><!-- card-media-img -->
                                                            <div class="card-media-body">
                                                                <h4><a href="product-details-v1.html">Somnium Rubram</a></h4>
                                                                <p class="fw-medium fs-14">Contact Address</p>
                                                                <p class="fs-15">08 W 36th St, New York, NY 10001</p>
                                                            </div><!-- end card-media-body -->
                                                        </div><!-- end card-media -->
                                                        <div class="card-media mb-3">
                                                            <div class="card-media-body">
                                                                <span class="fw-medium fs-13">Get Offer</span>
                                                                <p class="fw-medium text-black fs-14">$2,300.00</p>
                                                            </div>
                                                            <div class="card-media-body">
                                                                <span class="fw-medium fs-13">Payment Methods</span>
                                                                <p class="fw-medium text-black fs-14">Visa ending in 9720</p>
                                            ...
                                            <div class="col-xl-6">
                                                <div class="card card-full">
                                                    <div class="card-body card-body-s1">
                                                        <p class="mb-3 fs-13 mb-4">OOffer received 1h ago</p>
                                                        <div class="card-media mb-3">
                                                            <div class="card-media-img flex-shrink-0">
                                                                <img src="images/thumb/small-img-3.jpg" alt="media image">
                                                            </div><!-- card-media-img -->
                                                            <div class="card-media-body">
                                                                <h4><a href="product-details-v1.html">Dance or Die</a></h4>
                                                                <p class="fw-medium fs-14">Contact Address</p>
                                                                <p class="fs-15">08 W 36th St, New York, NY 10001</p>
                                                            </div><!-- end card-media-body -->
                                                        </div><!-- end card-media -->
                                                        <div class="card-media mb-3">
                                                            <div class="card-media-body">
                                                                <span class="fw-medium fs-13">Get Offer</span>
                                                                <p class="fw-medium text-black fs-14">$3,200.00</p>
                                                            </div>
                                                            <div class="card-media-body">
                                                                <span class="fw-medium fs-13">Payment Methods</span>
                                                                <p class="fw-medium text-black fs-14">Visa ending in 9720</p>
                                            ...
                                            <div class="col-xl-6">
                                                <div class="card card-full">
                                                    <div class="card-body card-body-s1">
                                                        <p class="mb-3 fs-13 mb-4">Offer received 1 week ago</p>
                                                        <div class="card-media mb-3">
                                                            <div class="card-media-img flex-shrink-0">
                                                                <img src="images/thumb/small-img-4.jpg" alt="media image">
                                                            </div><!-- card-media-img -->
                                                            <div class="card-media-body">
                                                                <h4><a href="product-details-v1.html">Genesis.001</a></h4>
                                                                <p class="fw-medium fs-14">Contact Address</p>
                                                                <p class="fs-15">08 W 36th St, New York, NY 10001</p>
                                                            </div><!-- end card-media-body -->
                                                        </div><!-- end card-media -->
                                            ...
                                            <div class="col-xl-6">
                                                <div class="card card-full">
                                                    <div class="card-body card-body-s1">
                                                        <p class="mb-3 fs-13 mb-4">Offer received 9h 30m ago</p>
                                                        <div class="card-media mb-3">
                                                            <div class="card-media-img flex-shrink-0">
                                                                <img src="images/thumb/small-img-5.jpg" alt="media image">
                                                            </div><!-- card-media-img -->
                                                            <div class="card-media-body">
                                                                <h4><a href="product-details-v1.html">Karma Chameleon</a></h4>
                                                                <p class="fw-medium fs-14">Contact Address</p>
                                                                <p class="fs-15">08 W 36th St, New York, NY 10001</p>
                                                            </div><!-- end card-media-body -->
                                                        </div><!-- end card-media -->
                                            ...
                                            <div class="col-xl-6">
                                                <div class="card card-full">
                                                    <div class="card-body card-body-s1">
                                                        ...
                                                        <div class="card-media mb-3">
                                                            <div class="card-media-img flex-shrink-0">
                                                                <img src="images/thumb/small-img-6.jpg" alt="media image">
                                                            </div><!-- card-media-img -->
                                                            <div class="card-media-body">
                                                                <h4><a href="product-details-v1.html">Detritus #17</a></h4>
                                                                <p class="fw-medium fs-14">Contact Address</p>
                                                                <p class="fs-15">08 W 36th St, New York, NY 10001</p>
                                                            </div><!-- end card-media-body -->
                                                        </div><!-- end card-media -->
                                                        <div class="card-media mb-3">
                                                            ...
                                                            <div class="card-media-body">
                                                                <span class="fw-medium fs-13">Payment Methods</span>
                                                                <p class="fw-medium text-black fs-14">Visa ending in 8720</p>
                                                            </div>
                                                        </div><!-- end d-flex -->
                                                        <ul class="btns-group">
                                                            <li><a href="#" class="btn-link flex-grow-1 fw-medium fs-13 text-success">Accept Offer</a></li>
                                ...
                                <div class="tab-pane fade" id="offers-made" role="tabpanel" aria-labelledby="offers-made-tab">
                                    <div class="profile-setting-panel">
                                        ...
                                        <h3 class="mb-1">Offers You've Made:</h3>
                                        <p class="mb-4 fs-14">Showing 1 to 6 of 10 entries</p>
                                        <div class="row g-gs">
                                            <div class="col-xl-6">
                                                <div class="card card-full">
                                                    <div class="card-body card-body-s1">
                                                        ...
                                                        <ul class="btns-group">
                                                            <li><span class="badge bg-info">Pending</span></li>
                                                            <li><a href="#" class="btn-link fw-medium fs-13 text-danger">Cancel Offer</a></li>
                                                        </ul>
                                                    </div><!-- end card-body -->
                                                </div><!-- end card -->
                                            </div><!-- end col -->
                                            ...
                                            <div class="col-xl-6">
                                                <div class="card card-full">
                                                    <div class="card-body card-body-s1">
                                                        ...
                                                        <ul class="btns-group">
                                                            <li><span class="badge bg-danger">Declined</span></li>
                                                        </ul>
                                                    </div><!-- end card-body -->
                                                </div><!-- end card -->
                                            </div><!-- end col -->

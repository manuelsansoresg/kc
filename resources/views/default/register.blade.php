...
<head>
    ...
    <title>Registration | EnftyMart - NFT Marketplace HTML Template</title>
    <!-- Favicon -->
                ...
                <div class="row align-items-center justify-content-center">
                    ...
                    <div class="col-lg-6 col-md-9">
                        <div class="section-head-sm">
                            <h2 class="mb-3">Sign Up to <span class="text-primary">EnftyMart!</span></h2>
                        ...
                        <form action="#">
                            ...
                            <button class="btn btn-dark w-100" type="submit">Create an Account</button>
                            <span class="d-block my-4">— or sign up with —</span>
                            <ul class="btns-group d-flex">
                                <li class="flex-grow-1"><a href="#" class="btn d-block bg-red-100 text-red g-btn"><em class="ni ni-google"></em> Google</a></li>
                                <li class="flex-grow-1"><a href="#" class="btn d-block bg-blue-100 text-blue f-btn"><em class="ni ni-facebook-f"></em> Facebook</a></li>
                                <li class="flex-grow-1"><a href="#" class="btn d-block bg-cyan-100 text-cyan t-btn"><em class="ni ni-twitter"></em> Twitter</a></li>
                            </ul>
                            <p class="mt-3 form-text">Already have an account <a href="login.html" class="btn-link">Login</a></p>
                        </form>
                    </div><!-- end col-lg-6 -->
                </div><!-- end row -->
            </div><!-- end container -->

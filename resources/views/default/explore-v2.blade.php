                        ...
                        <div class="card card-creator-s1">
                            <div class="card-body">
                                ...
                                <div class="flex-grow-1">
                                    <a href="author.html" class="text-black fw-semibold">@nathan_walls</a>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="card card-creator-s1">
                            <div class="card-body">
                                ...
                                <div class="flex-grow-1">
                                    <a href="author.html" class="text-black fw-semibold">@alex_smith</a>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="card card-creator-s1">
                            <div class="card-body">
                                ...
                                <div class="flex-grow-1">
                                    <a href="author.html" class="text-black fw-semibold">@kevin_martin</a>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="card card-creator-s1">
                            <div class="card-body">
                                ...
                                <div class="flex-grow-1">
                                    <a href="author.html" class="text-black fw-semibold">@david_martin</a>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="card card-creator-s1">
                            <div class="card-body">
                                ...
                                <div class="flex-grow-1">
                                    <a href="author.html" class="text-black fw-semibold">@jhonatan_doe</a>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="card card-creator-s1">
                            <div class="card-body">
                                ...
                                <div class="flex-grow-1">
                                    <a href="author.html" class="text-black fw-semibold">@mark_hardson</a>

...
<head>
    ...
    <title>Account | EnftyMart - NFT Marketplace HTML Template</title>
    <!-- Favicon -->
                    ...
                    <div class="col-lg-3">
                        ...
                        <div class="sidebar sidebar-user-mobile">
                            ...
                            <div class="sidebar-widget">
                                <ul class="user-nav">
                                    <li class="active"><a href="account.html"><em class="ni ni-edit me-2"></em>Edit Profile</a></li>
                        ...
                        <div class="profile-setting-panel-wrap">
                            <ul class="nav nav-tabs nav-tabs-s1 nav-tabs-mobile-size" id="myTab" role="tablist">
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link active" id="account-information-tab" data-bs-toggle="tab" data-bs-target="#account-information" type="button" role="tab" aria-controls="account-information" aria-selected="true"> Edit Info </button>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="change-password-tab" data-bs-toggle="tab" data-bs-target="#change-password" type="button" role="tab" aria-controls="change-password" aria-selected="false"> Password </button>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="validate-profile-tab" data-bs-toggle="tab" data-bs-target="#validate-profile" type="button" role="tab" aria-controls="validate-profile" aria-selected="false"> Verify Profile </button>
                                </li>
                            </ul>
                            <div class="tab-content mt-4" id="myTabContent">
                                ...
                                <div class="tab-pane fade" id="validate-profile" role="tabpanel" aria-labelledby="validate-profile-tab">
                                    <div class="profile-setting-panel">
                                        ...
                                        <p class="mb-3 fs-14">Verify your unique identity by linking your phone number with your account. Once your profile is verified, you will be approved to participate in all drops that require profile verification to purchase.</p>

    ...
    <div class="page-wrap">
                    ...
                    <div class="row align-items-center flex-lg-row-reverse justify-lg-content-center">
                        <div class="col-lg-6 col-sm-9">
                            <div class="row gx-4">
                                <div class="col-xl-8">
                                    <div class="card card-s2">
                                        <div class="card-image">
                                            <img src="images/thumb/nft-lg4.jpg" alt="" class="card-img-top">
                                        </div><!-- end cad-image -->
                                        <div class="card-body">
                                            ...
                                            <div class="card-author d-flex align-items-center">
                                                ...
                                                <a href="author.html" class="author-link">RukiStudio</a>
                                            </div><!-- end card-author -->
                                        </div><!-- end card-body -->
                                    </div><!-- end card -->
                                </div><!-- end col -->
                                <div class="col-xl-4 d-xl-block d-none">
                                    <div class="card card-s2">
                                        <div class="card-image">
                                            <img src="images/thumb/nft20.jpg" alt="" class="card-img-top">
                                        </div>
                                        <div class="card-body">
                                            <h5 class="card-title text-truncate"><a href="product-details-v1.html">Operation Jade Fury</a></h5>
                                            <div class="card-author d-flex align-items-center">
                                                <span class="me-1 card-author-by">By</span>
                                                <a href="author.html" class="author-link">CanvaNetwork</a>
                                            </div><!-- end card-author -->
                                        </div><!-- end card-body -->
                                    </div><!-- end card -->
                                    <div class="card card-s2">
                                        <div class="card-image">
                                            <img src="images/thumb/nft21.jpg" alt="" class="card-img-top">
                                        </div>
                                        <div class="card-body">
                                            <h5 class="card-title text-truncate"><a href="product-details-v1.html">One Tribe Black Edition</a></h5>
                                            <div class="card-author d-flex align-items-center">
                                                <span class="me-1 card-author-by">By</span>
                                                <a href="author.html" class="author-link">ZeniconStudio</a>
                                            </div><!-- end card-author -->
                                        </div><!-- end card-body -->
                                    </div>
                                </div><!-- end col -->
                        ...
                        <div class="col-lg-6 col-sm-9">
                            <div class="hero-content pt-lg-0 pb-0 mt-lg-n4">
                                <h6 class="hero-meta text-uppercase text-primary mb-3">largest nft marketplace</h6>
                                <h1 class="hero-title">Explore Thousands of Digital Arts and Collectibles</h1>
        ...
        <section class="brand-section bg-gray py-5">
            <div class="container">
                <div class="row">
                    <div class="col-lg-4">
                        <div class="brand-heading py-3 py-lg-0">
                    ...
                    <div class="col-lg-8">
                        <div class="row g-gs">
                            ...
                            <div class="col-6 col-md-3 col-sm-4">
                                <div class="client-logo-item text-center">
                                    <img src="images/brand/brand-2.png" alt="" class="img-fluid">
                                </div><!-- end client-logo-item -->
                            </div><!-- end col -->
                            <div class="col-6 col-md-3 col-sm-4">
                                <div class="client-logo-item text-center">
                                    <img src="images/brand/brand-3.png" alt="" class="img-fluid">
                                </div><!-- end client-logo-item -->
                            </div><!-- end col -->
                            <div class="col-6 col-md-3 col-sm-4">
                                <div class="client-logo-item text-center">
                                    <img src="images/brand/brand-4.png" alt="" class="img-fluid">
                                </div><!-- end client-logo-item -->
                            </div><!-- end col -->
                        </div><!-- end row -->
                    </div><!-- end col -->
                        ...
                        <div class="col-lg-8 mx-auto">
                            <ul class="nav nav-pills nav-pills-s1 mb-5 justify-content-center" id="pills-tab" role="tablist">
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link active" id="pills-connect-wallet-tab" data-bs-toggle="pill" data-bs-target="#pills-connect-wallet" type="button"> Connect Your Wallet </button>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="pills-create-nft-store-tab" data-bs-toggle="pill" data-bs-target="#pills-create-nft-store" type="button"> Create Your NFT Store </button>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="pills-start-selling-tab" data-bs-toggle="pill" data-bs-target="#pills-start-selling" type="button"> Start Selling &amp; Growing </button>
                                </li>
                            </ul>
                        </div><!-- end col -->
                        <div class="col-lg-12">
                            <div class="tab-content" id="pills-tabContent">
                                    ...
                                    <div class="row align-items-center justify-content-center">
                                        <div class="col-lg-4">
                                            <div class="card-tab-img mb-5 mb-lg-0">
                                                <img src="images/thumb/tabs01.png" alt="" class="img">
                                            </div>
                                        </div><!-- end col -->
                                        <div class="col-lg-7 ps-lg-5">
                                            <div class="card-tab">
                                                ...
                                                <a href="wallet.html" class="btn btn-outline-dark">Create Store</a>
                                            </div><!-- end card-tab -->
                                        </div><!-- end col -->
                                    </div><!-- end row -->
                                </div><!-- end tab-pane -->
                                <div class="tab-pane" id="pills-create-nft-store" role="tabpanel" aria-labelledby="pills-create-nft-store-tab">
                                    <div class="row align-items-center justify-content-center">
                                        <div class="col-lg-4">
                                            <div class="card-tab-img mb-5 mb-lg-0">
                                                <img src="images/thumb/tabs02.png" alt="" class="img">
                                            </div>
                                        </div><!-- end col -->
                                        <div class="col-lg-7 ps-lg-5">
                                            <div class="card-tab">
                                ...
                                <div class="tab-pane" id="pills-start-selling" role="tabpanel" aria-labelledby="pills-start-selling-tab">
                                    <div class="row align-items-center justify-content-center">
                                        <div class="col-lg-4">
                                            <div class="card-tab-img mb-5 mb-lg-0">
                                                <img src="images/thumb/tabs03.png" alt="" class="img">
                                            </div>
                                        </div><!-- end col -->
                                        <div class="col-lg-7 ps-lg-5">
                                            <div class="card-tab">
        ...
        <section class="section-space trending-section bg-gray">
            <div class="container">
                ...
                <div class="text-center mt-4 mt-md-5">
                    <a href="explore-v5.html" class="btn-link btn-link-s1">View all auctions</a>
                </div>
            </div><!-- end container -->
        </section>
                        ...
                        <div class="card card-creator-s1 card-creator-s1-h">
                            <div class="card-body">
                                ...
                                <div class="flex-grow-1">
                                    <a href="author.html" class="card-title">@nathan_walls</a>
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <div class="card card-creator-s1 card-creator-s1-h">
                            <div class="card-body">
                                ...
                                <div class="flex-grow-1">
                                    <a href="author.html" class="card-title">@alex_smith</a>
                                    <span class="d-block fw-medium">21.13 ETH</span>
                                </div>
                            </div><!-- end card -->
                        </div><!-- end card -->
                    </div><!-- end col -->
                    <div class="col-lg-4 col-sm-6">
                        <div class="card card-creator-s1 card-creator-s1-h">
                            <div class="card-body">
                                ...
                                <div class="flex-grow-1">
                                    <a href="author.html" class="card-title">@kevin_martin</a>
                                    <span class="d-block fw-medium">20.13 ETH</span>
                                </div>
                            </div><!-- end card -->
                        </div><!-- end card -->
                    </div><!-- end col -->
                    <div class="col-lg-4 col-sm-6">
                        <div class="card card-creator-s1 card-creator-s1-h">
                            <div class="card-body">
                                ...
                                <div class="flex-grow-1">
                                    <a href="author.html" class="card-title">@david_martin</a>
                                    <span class="d-block fw-medium">21.13 ETH</span>
                                </div>
                            </div><!-- end card -->
                        </div><!-- end card -->
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <div class="card card-creator-s1 card-creator-s1-h">
                            <div class="card-body">
                                ...
                                <div class="flex-grow-1">
                                    <a href="author.html" class="card-title">@jhonatan_doe</a>
                                    <span class="d-block fw-medium">22.13 ETH</span>
                                </div>
                            </div><!-- end card -->
                        </div><!-- end card -->
                    </div><!-- end col -->
                    <div class="col-lg-4 col-sm-6">
                        <div class="card card-creator-s1 card-creator-s1-h">
                            <div class="card-body">
                                ...
                                <div class="flex-grow-1">
                                    <a href="author.html" class="card-title">@mark_hardson</a>

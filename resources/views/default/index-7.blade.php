    ...
    <div class="page-wrap">
        <header class="header-section has-header-main">
                ...
                <div class="container">
                    <div class="header-wrap">
                        ...
                        <nav class="header-menu menu nav">
                            ...
                            <ul class="menu-btns">
                                <li><a href="wallet.html" class="btn btn-dark">Connect Wallet</a></li>
                                <li>
            ...
            <div class=" hero-slider-wrap">
                <div class="container">
                    <div class="swiper swiper-carousel swiper-button-s1 swiper-button-s2 on-dark animated" data-breakpoints='{
                        "0":{"slidesPerView":1,"slidesPerGroup":1}
                        }' data-loop="true" navigation="true" data-autoplay="false" data-speed="500" data-centeredslides="false" data-effect="fade">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide h-auto">
                                <div class="slider-full-screen set-bg" data-set-bg="images/thumb/nft-full.jpg">
                                    <div class="row">
                                        <div class="slider-full-body col-lg-6 col-md-8 col-sm-9">
                                            <h2 class="mb-3 card-title">Discover, collect, and sell extraordinary NFT's Assets</h2>
                                            <p class="mb-4 card-text">Securely buy and sell unique digital collectibles. Lowest transaction costs across all NFT markets guaranteed.</p>
                            ...
                            <div class="swiper-slide h-auto">
                                <div class="slider-full-screen set-bg" data-set-bg="images/thumb/nft-full-2.jpg">
                                    <div class="row">
                                        <div class="slider-full-body col-lg-6 col-md-8 col-sm-9">
                                            <h2 class="mb-3 card-title">Exclusive digital asset</h2>
                                            <p class="mb-4 card-text">There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some.</p>
                                            <ul class="btns-group hero-btns">
                                                <li><a href="explore.html" class="btn btn-lg btn-dark">Explore</a></li>
                                                <li><a href="create.html" class="btn btn-lg btn-outline-dark">Create</a></li>
                                            </ul>
                            ...
                            <div class="swiper-slide h-auto">
                                <div class="slider-full-screen set-bg" data-set-bg="images/thumb/nft-full-3.jpg">
                                    <div class="row">
                                        <div class="slider-full-body col-lg-6 col-md-8 col-sm-9">
                                            <h2 class="mb-3 card-title">NFT Marketplace Explore, collect, and sell NFTs</h2>
                                            <p class="mb-4 card-text">If you are working with any type of Digital NFT Marketplace, and Development Firm for every industry then EnftyMat.</p>
                                            <ul class="btns-group hero-btns">
                                                <li><a href="explore.html" class="btn btn-lg btn-dark">Explore</a></li>
                                                <li><a href="create.html" class="btn btn-lg btn-outline-dark">Create</a></li>
                                            </ul>
        ...
        <section class="section-space trending-section bg-gray">
            <div class="container">
                            ...
                            <div class="card-author d-flex align-items-center justify-content-between pb-3">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="custom-tooltip-wrap card-author-by-wrap">
                                        ...
                                        <a href="author.html" class="custom-tooltip author-link">ZeniconStudio</a>
                                        <div class="card-generic custom-tooltip-dropdown">
                                            <div class="author-action d-flex flex-wrap align-items-center mb-3">
                                                ...
                                                <div class="ms-2">
                                                    <span class="author-username">@zenicon_studio</span>
                                                    <span class="author-follow-text">1.3k Followers</span>
                                                </div>
                                            </div>
                                            <h6 class="author-name mb-1">Zenicon Studio</h6>
                                            ...
                                            <div class="follow-wrap mb-3">
                                                ...
                                                <div class="avatar-group">
                                                    <a href="author.html" class="avatar-group-avatar">
                                                        <img src="images/thumb/avatar.jpg" alt="avatar">
                                                    </a>
                                                    <a href="author.html" class="avatar-group-avatar">
                                                    ...
                                                    <a href="author.html" class="avatar-group-avatar">
                                                        <img src="images/thumb/avatar-5.jpg" alt="avatar">
                                                    </a>
                                                </div>
                                            </div><!-- end follow-wrap  -->
                                            <a href="author.html" class="btn btn-sm bg-dark-dim">Follow</a>
                                        </div><!-- end dropdown-menu -->
                                    </div><!-- end custom-tootltip-wrap -->
                                </div>
                            </div><!-- end card-author -->
                            <div class="card-image">
                                <img src="images/thumb/nft-2.jpg" class="card-img" alt="art image">
                            </div><!-- end card-image -->
                            <div class="card-body px-0 pb-0">
                                <h5 class="card-title text-truncate"><a href="product-details-v1.html">One Tribe Black Edition</a></h5>
                                <div class="card-price-wrap d-flex align-items-center justify-content-sm-between pb-3">
                                    ...
                                    <div class="text-sm-end">
                                        ...
                                        <span class="card-price-number d-block">1.32 ETH</span>
                                    </div>
                                </div><!-- end card-price-wrap -->
                                <a href="product-details-v1.html" class="btn btn-sm btn-dark">Place Bid</a>
                            </div><!-- end card-body -->
                        </div><!-- end card -->
                    </div><!-- end col -->
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                        <div class="card card-full card-s3">
                            <div class="card-author d-flex align-items-center justify-content-between pb-3">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="custom-tooltip-wrap card-author-by-wrap">
                                        <span class="card-author-by card-author-by-2">Owned by</span>
                                        <a href="author.html" class="custom-tooltip author-link">CanvaNetwork</a>
                                        <div class="card-generic custom-tooltip-dropdown">
                                            <div class="author-action d-flex flex-wrap align-items-center mb-3">
                                                <div class="flex-shrink-0 avatar">
                                                    <img src="images/thumb/avatar-2.jpg" alt="avatar">
                            ...
                            <div class="card-image">
                                <img src="images/thumb/nft3.jpg" class="card-img" alt="art image">
                            </div><!-- end card-image -->
                            <div class="card-body px-0 pb-0">
                                <h5 class="card-title text-truncate"><a href="product-details-v1.html">Operation Jade Fury</a></h5>
                                <div class="card-price-wrap d-flex align-items-center justify-content-sm-between pb-3">
                                    <div class="me-5 me-sm-2">
                                        <span class="card-price-title">Price</span>
                                        <span class="card-price-number">$14.20</span>
                        ...
                        <div class="card card-full card-s3">
                            <div class="card-author d-flex align-items-center justify-content-between pb-3">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="custom-tooltip-wrap card-author-by-wrap">
                                        <span class="card-author-by card-author-by-2">Owned by</span>
                                        <a href="author.html" class="custom-tooltip author-link">MoveNetwork</a>
                                        <div class="card-generic custom-tooltip-dropdown">
                                            <div class="author-action d-flex flex-wrap align-items-center mb-3">
                                                <div class="flex-shrink-0 avatar">
                                                    <img src="images/thumb/avatar-3.jpg" alt="avatar">
                                                ...
                                                <div class="ms-2">
                                                    <span class="author-username">@move_network</span>
                                                    <span class="author-follow-text">1.3k Followers</span>
                                                </div>
                                            </div>
                                            <h6 class="author-name mb-1">Move Network</h6>
                                            <p class="author-desc smaller mb-3">Complete account of the system, and expound the actual things.</p>
                                            <div class="follow-wrap mb-3">
                                                <h6 class="mb-1 smaller text-uppercase">Followed by</h6>
                                                <div class="avatar-group">
                            ...
                            <div class="card-image">
                                <img src="images/thumb/nft4.jpg" class="card-img" alt="art image">
                            </div><!-- end card-image -->
                            <div class="card-body px-0 pb-0">
                                <h5 class="card-title text-truncate"><a href="product-details-v1.html">Unboxing The Compass</a></h5>
                                <div class="card-price-wrap d-flex align-items-center justify-content-sm-between pb-3">
                                    <div class="me-5 me-sm-2">
                                        <span class="card-price-title">Price</span>
                                        <span class="card-price-number">$14.20</span>
                        ...
                        <div class="card card-full card-s3">
                            <div class="card-author d-flex align-items-center justify-content-between pb-3">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="custom-tooltip-wrap card-author-by-wrap">
                                        <span class="card-author-by card-author-by-2">Owned by</span>
                                        <a href="author.html" class="custom-tooltip author-link">RukiStudio</a>
                                        <div class="card-generic custom-tooltip-dropdown">
                                            <div class="author-action d-flex flex-wrap align-items-center mb-3">
                                                <div class="flex-shrink-0 avatar">
                                                    <img src="images/thumb/avatar-4.jpg" alt="avatar">
                                            ...
                                            <h6 class="author-name mb-1">Ruki Studio</h6>
                                            <p class="author-desc smaller mb-3">Complete account of the system, and expound the actual things.</p>
                                            <div class="follow-wrap mb-3">
                                                <h6 class="mb-1 smaller text-uppercase">Followed by</h6>
                                                <div class="avatar-group">
                            ...
                            <div class="card-image">
                                <img src="images/thumb/nft5.jpg" class="card-img" alt="art image">
                            </div><!-- end card-image -->
                            <div class="card-body px-0 pb-0">
                                <h5 class="card-title text-truncate"><a href="product-details-v1.html">Rendering by the Water</a></h5>
                                <div class="card-price-wrap d-flex align-items-center justify-content-sm-between pb-3">
                                    <div class="me-5 me-sm-2">
                                        <span class="card-price-title">Price</span>
                                        <span class="card-price-number">$14.20</span>
                        ...
                        <div class="card card-full card-s3">
                            <div class="card-author d-flex align-items-center justify-content-between pb-3">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="custom-tooltip-wrap card-author-by-wrap">
                                        <span class="card-author-by card-author-by-2">Owned by</span>
                                        <a href="author.html" class="custom-tooltip author-link">JisanMedia</a>
                                        <div class="card-generic custom-tooltip-dropdown">
                                            <div class="author-action d-flex flex-wrap align-items-center mb-3">
                                                <div class="flex-shrink-0 avatar">
                                                    <img src="images/thumb/avatar-5.jpg" alt="avatar">
                                                ...
                                                <div class="ms-2">
                                                    <span class="author-username">@jisan_media</span>
                                                    <span class="author-follow-text">1.3k Followers</span>
                                                </div>
                                            </div>
                                            <h6 class="author-name mb-1">Jisan Media</h6>
                                            <p class="author-desc smaller mb-3">Complete account of the system, and expound the actual things.</p>
                                            <div class="follow-wrap mb-3">
                                                <h6 class="mb-1 smaller text-uppercase">Followed by</h6>
                                                <div class="avatar-group">
                            ...
                            <div class="card-image">
                                <img src="images/thumb/nft6.jpg" class="card-img" alt="art image">
                            </div><!-- end card-image -->
                            <div class="card-body px-0 pb-0">
                                <h5 class="card-title text-truncate"><a href="product-details-v1.html">Divine Opulence</a></h5>
                                <div class="card-price-wrap d-flex align-items-center justify-content-sm-between pb-3">
                                    <div class="me-5 me-sm-2">
                                        <span class="card-price-title">Price</span>
                                        <span class="card-price-number">$14.20</span>
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                        <div class="card card-full card-s3">
                            <div class="card-author d-flex align-items-center justify-content-between pb-3">
                                <div class="d-flex align-items-center">
                                    <a href="author.html" class="avatar me-1">
                                        <img src="images/thumb/avatar-6.jpg" alt="avatar">
                                    </a>
                                    <div class="custom-tooltip-wrap card-author-by-wrap">
                                        <span class="card-author-by card-author-by-2">Owned by</span>
                                        <a href="author.html" class="custom-tooltip author-link">CanvaNetwork</a>
                            ...
                            <div class="card-image">
                                <img src="images/thumb/nft7.jpg" class="card-img" alt="art image">
                            </div><!-- end card-image -->
                            <div class="card-body px-0 pb-0">
                                <h5 class="card-title text-truncate"><a href="product-details-v1.html">Sacral Metatron Cube</a></h5>
                                <div class="card-price-wrap d-flex align-items-center justify-content-sm-between pb-3">
                                    <div class="me-5 me-sm-2">
                                        <span class="card-price-title">Price</span>
                                        <span class="card-price-number">$14.20</span>
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                        <div class="card card-full card-s3">
                            <div class="card-author d-flex align-items-center justify-content-between pb-3">
                                <div class="d-flex align-items-center">
                                    <a href="author.html" class="avatar me-1">
                                        <img src="images/thumb/avatar-7.jpg" alt="avatar">
                                    </a>
                                    <div class="custom-tooltip-wrap card-author-by-wrap">
                                        <span class="card-author-by card-author-by-2">Owned by</span>
                                        <a href="author.html" class="custom-tooltip author-link">NioStudio</a>
                                        <div class="card-generic custom-tooltip-dropdown">
                                            <div class="author-action d-flex flex-wrap align-items-center mb-3">
                                                <div class="flex-shrink-0 avatar">
                                                    <img src="images/thumb/avatar-7.jpg" alt="avatar">
                                                ...
                                                <div class="ms-2">
                                                    <span class="author-username">@nio_studio</span>
                                                    <span class="author-follow-text">1.3k Followers</span>
                                                </div>
                                            </div>
                                            <h6 class="author-name mb-1">Nio Studio</h6>
                                            <p class="author-desc smaller mb-3">Complete account of the system, and expound the actual things.</p>
                                            <div class="follow-wrap mb-3">
                                                <h6 class="mb-1 smaller text-uppercase">Followed by</h6>
                                                <div class="avatar-group">
                            ...
                            <div class="card-image">
                                <img src="images/thumb/nft8.jpg" class="card-img" alt="art image">
                            </div><!-- end card-image -->
                            <div class="card-body px-0 pb-0">
                                <h5 class="card-title text-truncate"><a href="product-details-v1.html">Girl warming up to a bed acrobat</a></h5>
                                <div class="card-price-wrap d-flex align-items-center justify-content-sm-between pb-3">
                                    <div class="me-5 me-sm-2">
                                        <span class="card-price-title">Price</span>
                                        <span class="card-price-number">$14.20</span>
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                        <div class="card card-full card-s3">
                            <div class="card-author d-flex align-items-center justify-content-between pb-3">
                                <div class="d-flex align-items-center">
                                    <a href="author.html" class="avatar me-1">
                                        <img src="images/thumb/avatar-8.jpg" alt="avatar">
                                    </a>
                                    <div class="custom-tooltip-wrap card-author-by-wrap">
                                        <span class="card-author-by card-author-by-2">Owned by</span>
                                        <a href="author.html" class="custom-tooltip author-link">ParsaMedia</a>
                                        <div class="card-generic custom-tooltip-dropdown">
                                            <div class="author-action d-flex flex-wrap align-items-center mb-3">
                                                <div class="flex-shrink-0 avatar">
                                                    <img src="images/thumb/avatar-8.jpg" alt="avatar">
                                                ...
                                                <div class="ms-2">
                                                    <span class="author-username">@parsa_media</span>
                                                    <span class="author-follow-text">1.3k Followers</span>
                                                </div>
                                            </div>
                                            <h6 class="author-name mb-1">Parsa Media</h6>
                                            <p class="author-desc smaller mb-3">Complete account of the system, and expound the actual things.</p>
                                            <div class="follow-wrap mb-3">
                                                <h6 class="mb-1 smaller text-uppercase">Followed by</h6>
                                                <div class="avatar-group">
                            ...
                            <div class="card-image">
                                <img src="images/thumb/nft9.jpg" class="card-img" alt="art image">
                            </div><!-- end card-image -->
                            <div class="card-body px-0 pb-0">
                                <h5 class="card-title text-truncate"><a href="product-details-v1.html">Women Eyes Modern Art</a></h5>
                                <div class="card-price-wrap d-flex align-items-center justify-content-sm-between pb-3">
                                    <div class="me-5 me-sm-2">
                                        <span class="card-price-title">Price</span>
                                        <span class="card-price-number">$14.20</span>
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                        <div class="card card-full card-s3">
                            <div class="card-author d-flex align-items-center justify-content-between pb-3">
                                <div class="d-flex align-items-center">
                                    <a href="author.html" class="avatar me-1">
                                        <img src="images/thumb/avatar-9.jpg" alt="avatar">
                                    </a>
                                    <div class="custom-tooltip-wrap card-author-by-wrap">
                                        <span class="card-author-by card-author-by-2">Owned by</span>
                                        <a href="author.html" class="custom-tooltip author-link">RukonNetwork</a>
                                        <div class="card-generic custom-tooltip-dropdown">
                                            <div class="author-action d-flex flex-wrap align-items-center mb-3">
                                                <div class="flex-shrink-0 avatar">
                                                    <img src="images/thumb/avatar-9.jpg" alt="avatar">
                                                ...
                                                <div class="ms-2">
                                                    <span class="author-username">@rukon_network</span>
                                                    <span class="author-follow-text">1.3k Followers</span>
                                                </div>
                                            </div>
                                            <h6 class="author-name mb-1">Rukon Network</h6>
                                            <p class="author-desc smaller mb-3">Complete account of the system, and expound the actual things.</p>
                                            <div class="follow-wrap mb-3">
                                                <h6 class="mb-1 smaller text-uppercase">Followed by</h6>
                                                <div class="avatar-group">
                            ...
                            <div class="card-image">
                                <img src="images/thumb/nft16.jpg" class="card-img" alt="art image">
                            </div><!-- end card-image -->
                            <div class="card-body px-0 pb-0">
                                <h5 class="card-title text-truncate"><a href="product-details-v1.html">Puffy Baby Bird #151</a></h5>
                                <div class="card-price-wrap d-flex align-items-center justify-content-sm-between pb-3">
                                    <div class="me-5 me-sm-2">
                                        <span class="card-price-title">Price</span>
                                        <span class="card-price-number">$14.20</span>
                        ...
                        <div class="card card-full card-s3">
                            <div class="card-author d-flex align-items-center justify-content-between pb-3">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="custom-tooltip-wrap card-author-by-wrap">
                                        <span class="card-author-by card-author-by-2">Owned by</span>
                                        <a href="author.html" class="custom-tooltip author-link">FoxStudio</a>
                                        <div class="card-generic custom-tooltip-dropdown">
                                            <div class="author-action d-flex flex-wrap align-items-center mb-3">
                                                <div class="flex-shrink-0 avatar">
                                                    <img src="images/thumb/avatar-10.jpg" alt="avatar">
                                                ...
                                                <div class="ms-2">
                                                    <span class="author-username">@fox_studio</span>
                                                    <span class="author-follow-text">1.3k Followers</span>
                                                </div>
                                            </div>
                                            <h6 class="author-name mb-1">Fox Studio</h6>
                                            <p class="author-desc smaller mb-3">Complete account of the system, and expound the actual things.</p>
                                            <div class="follow-wrap mb-3">
                                                <h6 class="mb-1 smaller text-uppercase">Followed by</h6>
                                                <div class="avatar-group">
                            ...
                            <div class="card-image">
                                <img src="images/thumb/nft17.jpg" class="card-img" alt="art image">
                            </div><!-- end card-image -->
                            <div class="card-body px-0 pb-0">
                                <h5 class="card-title text-truncate"><a href="product-details-v1.html">Wave1 - Titanium Ticket</a></h5>
                                <div class="card-price-wrap d-flex align-items-center justify-content-sm-between pb-3">
                                    <div class="me-5 me-sm-2">
                                        <span class="card-price-title">Price</span>
                                        <span class="card-price-number">$14.20</span>
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                        <div class="card card-full card-s3">
                            <div class="card-author d-flex align-items-center justify-content-between pb-3">
                                <div class="d-flex align-items-center">
                                    <a href="author.html" class="avatar me-1">
                                        <img src="images/thumb/avatar-11.jpg" alt="avatar">
                                    </a>
                                    <div class="custom-tooltip-wrap card-author-by-wrap">
                                        <span class="card-author-by card-author-by-2">Owned by</span>
                                        <a href="author.html" class="custom-tooltip author-link">GoldMine</a>
                                        <div class="card-generic custom-tooltip-dropdown">
                                            <div class="author-action d-flex flex-wrap align-items-center mb-3">
                                                <div class="flex-shrink-0 avatar">
                                                    <img src="images/thumb/avatar-11.jpg" alt="avatar">
                                                ...
                                                <div class="ms-2">
                                                    <span class="author-username">@gold_mine</span>
                                                    <span class="author-follow-text">1.3k Followers</span>
                                                </div>
                                            </div>
                                            <h6 class="author-name mb-1">Gold Mine</h6>
                                            <p class="author-desc smaller mb-3">Complete account of the system, and expound the actual things.</p>
                                            <div class="follow-wrap mb-3">
                                                <h6 class="mb-1 smaller text-uppercase">Followed by</h6>
                                                <div class="avatar-group">
                            ...
                            <div class="card-image">
                                <img src="images/thumb/nft18.jpg" class="card-img" alt="art image">
                            </div><!-- end card-image -->
                            <div class="card-body px-0 pb-0">
                                <h5 class="card-title text-truncate"><a href="product-details-v1.html">Saggezza 2/4. Cartier Edition</a></h5>
                                <div class="card-price-wrap d-flex align-items-center justify-content-sm-between pb-3">
                                    <div class="me-5 me-sm-2">
                                        <span class="card-price-title">Price</span>
                                        <span class="card-price-number">$14.20</span>
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                        <div class="card card-full card-s3">
                            <div class="card-author d-flex align-items-center justify-content-between pb-3">
                                <div class="d-flex align-items-center">
                                    <a href="author.html" class="avatar me-1">
                                        <img src="images/thumb/avatar-12.jpg" alt="avatar">
                                    </a>
                                    <div class="custom-tooltip-wrap card-author-by-wrap">
                                        <span class="card-author-by card-author-by-2">Owned by</span>
                                        <a href="author.html" class="custom-tooltip author-link">PlutinumNetwork</a>
                                        <div class="card-generic custom-tooltip-dropdown">
                                            <div class="author-action d-flex flex-wrap align-items-center mb-3">
                                                <div class="flex-shrink-0 avatar">
                                                    <img src="images/thumb/avatar-12.jpg" alt="avatar">
                                                ...
                                                <div class="ms-2">
                                                    <span class="author-username">@plutinum_network</span>
                                                    <span class="author-follow-text">1.3k Followers</span>
                                                </div>
                                            </div>
                                            <h6 class="author-name mb-1">Plutinum Network</h6>
                                            <p class="author-desc smaller mb-3">Complete account of the system, and expound the actual things.</p>
                                            <div class="follow-wrap mb-3">
                                                <h6 class="mb-1 smaller text-uppercase">Followed by</h6>
                                                <div class="avatar-group">
                            ...
                            <div class="card-image">
                                <img src="images/thumb/nft19.jpg" class="card-img" alt="art image">
                            </div><!-- end card-image -->
                            <div class="card-body px-0 pb-0">
                                <h5 class="card-title text-truncate"><a href="product-details-v1.html">Venus (Viktoria Veisbrut & SoldArt)</a></h5>
                                <div class="card-price-wrap d-flex align-items-center justify-content-sm-between pb-3">
                                    <div class="me-5 me-sm-2">
                                        <span class="card-price-title">Price</span>
                                        <span class="card-price-number">$14.20</span>
                ...
                <div class="text-center mt-4 mt-md-5">
                    <a href="explore-v6.html" class="btn-link btn-link-s1">View all auctions</a>
                </div>
            </div><!-- end container -->
            ...
            <div class="container">
                ...
                <div class="row g-gs">
                    <div class="col-lg-3 col-sm-6">
                        <div class="card-creator-v card-creator-v-wbg card-creator-v-wbg-s1 pt-0 pb-4">
                            <div class="card-creator-info">
                                <a href="author.html" class="avatar avatar-1 flex-shrink-0 mb-2">
                                    <img src="images/thumb/avatar.jpg" alt="avatar">
                                    <span class="card-creator-number">1</span>
                                </a>
                                <div class="flex-grow-1">
                                    <a href="author.html" class="card-title">Nathan Walls</a>
                                    <span class="d-block fw-medium card-amount">24.13 ETH</span>
                                </div>
                            </div>
                        </div><!-- end card -->
                    </div><!-- end col-lg-4 -->
                    <div class="col-lg-3 col-sm-6">
                        <div class="card-creator-v card-creator-v-wbg card-creator-v-wbg-s1 pt-0 pb-4">
                            <div class="card-creator-info">
                                <a href="author.html" class="avatar avatar-1 flex-shrink-0 mb-2">
                                    <img src="images/thumb/avatar-2.jpg" alt="avatar">
                                    <span class="card-creator-number">2</span>
                                </a>
                                <div class="flex-grow-1">
                                    <a href="author.html" class="card-title">Alex Smith</a>
                                    <span class="d-block fw-medium card-amount">12.24 ETH</span>
                                </div>
                            </div>
                        </div><!-- end card -->
                    </div><!-- end col-lg-4 -->
                    <div class="col-lg-3 col-sm-6">
                        <div class="card-creator-v card-creator-v-wbg card-creator-v-wbg-s1 pt-0 pb-4">
                            <div class="card-creator-info">
                                <a href="author.html" class="avatar avatar-1 flex-shrink-0 mb-2">
                                    <img src="images/thumb/avatar-3.jpg" alt="avatar">
                                    <span class="card-creator-number">3</span>
                                </a>
                                <div class="flex-grow-1">
                                    <a href="author.html" class="card-title">Kevin Martin</a>
                                    <span class="d-block fw-medium card-amount">13.57 ETH</span>
                                </div>
                            </div>
                        </div><!-- end card -->
                    </div><!-- end col-lg-4 -->
                    <div class="col-lg-3 col-sm-6">
                        <div class="card-creator-v card-creator-v-wbg card-creator-v-wbg-s1 pt-0 pb-4">
                            <div class="card-creator-info">
                                <a href="author.html" class="avatar avatar-1 flex-shrink-0 mb-2">
                                    <img src="images/thumb/avatar-4.jpg" alt="avatar">
                                    <span class="card-creator-number">4</span>
                                </a>
                                <div class="flex-grow-1">
                                    <a href="author.html" class="card-title">David Martin</a>
                                    <span class="d-block fw-medium card-amount">34.13 ETH</span>
                                </div>
                            </div>
                        </div><!-- end card -->
                    </div><!-- end col-lg-4 -->
                    <div class="col-lg-3 col-sm-6">
                        <div class="card-creator-v card-creator-v-wbg card-creator-v-wbg-s1 pt-0 pb-4">
                            <div class="card-creator-info">
                                <a href="author.html" class="avatar avatar-1 flex-shrink-0 mb-2">
                                    <img src="images/thumb/avatar-5.jpg" alt="avatar">
                                    <span class="card-creator-number">5</span>
                                </a>
                                <div class="flex-grow-1">
                                    <a href="author.html" class="card-title">Jhonatan Doe</a>
                                    <span class="d-block fw-medium card-amount">23.24 ETH</span>
                                </div>
                            </div>
                        </div><!-- end card -->
                    </div><!-- end col-lg-4 -->
                    <div class="col-lg-3 col-sm-6">
                        <div class="card-creator-v card-creator-v-wbg card-creator-v-wbg-s1 pt-0 pb-4">
                            <div class="card-creator-info">
                                <a href="author.html" class="avatar avatar-1 flex-shrink-0 mb-2">
                                    <img src="images/thumb/avatar-6.jpg" alt="avatar">
                                    <span class="card-creator-number">6</span>
                                </a>
                                <div class="flex-grow-1">
                                    <a href="author.html" class="card-title">Mark Hardson</a>
                                    <span class="d-block fw-medium card-amount">34.57 ETH</span>
                                </div>
                            </div>
                        </div><!-- end card -->
                    </div><!-- end col-lg-4 -->
                    <div class="col-lg-3 col-sm-6">
                        <div class="card-creator-v card-creator-v-wbg card-creator-v-wbg-s1 pt-0 pb-4">
                            <div class="card-creator-info">
                                <a href="author.html" class="avatar avatar-1 flex-shrink-0 mb-2">
                                    <img src="images/thumb/avatar-7.jpg" alt="avatar">
                                    <span class="card-creator-number">7</span>
                                </a>
                                <div class="flex-grow-1">
                                    <a href="author.html" class="card-title">Gayle Hicks</a>
                                    <span class="d-block fw-medium card-amount">34.57 ETH</span>
                                </div>
                            </div>
                        </div><!-- end card -->
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="card-creator-v card-creator-v-wbg card-creator-v-wbg-s1 pt-0 pb-4">
                            <div class="card-creator-info">
                                <a href="author.html" class="avatar avatar-1 flex-shrink-0 mb-2">
                                    <img src="images/thumb/avatar-8.jpg" alt="avatar">
                                    <span class="card-creator-number">8</span>
                                </a>
                                <div class="flex-grow-1">
                                    <a href="author.html" class="card-title">Claude Banks</a>
                                    <span class="d-block fw-medium card-amount">34.57 ETH</span>
                                </div>
                            </div>
                        </div><!-- end card -->
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="card-creator-v card-creator-v-wbg card-creator-v-wbg-s1 pt-0 pb-4">
                            <div class="card-creator-info">
                                <a href="author.html" class="avatar avatar-1 flex-shrink-0 mb-2">
                                    <img src="images/thumb/avatar-9.jpg" alt="avatar">
                                    <span class="card-creator-number">9</span>
                                </a>
                                <div class="flex-grow-1">
                                    <a href="author.html" class="card-title">Stacy Long</a>
                                    <span class="d-block fw-medium card-amount">34.57 ETH</span>
                                </div>
                            </div>
                        </div><!-- end card -->
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="card-creator-v card-creator-v-wbg card-creator-v-wbg-s1 pt-0 pb-4">
                            <div class="card-creator-info">
                                <a href="author.html" class="avatar avatar-1 flex-shrink-0 mb-2">
                                    <img src="images/thumb/avatar-10.jpg" alt="avatar">
                                    <span class="card-creator-number">10</span>
                                </a>
                                <div class="flex-grow-1">
                                    <a href="author.html" class="card-title">Fred Ryan</a>
                                    <span class="d-block fw-medium card-amount">34.57 ETH</span>
                                </div>
                            </div>
                        </div><!-- end card -->
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="card-creator-v card-creator-v-wbg card-creator-v-wbg-s1 pt-0 pb-4">
                            <div class="card-creator-info">
                                <a href="author.html" class="avatar avatar-1 flex-shrink-0 mb-2">
                                    <img src="images/thumb/avatar-11.jpg" alt="avatar">
                                    <span class="card-creator-number">11</span>
                                </a>
                                <div class="flex-grow-1">
                                    <a href="author.html" class="card-title">Franklin Greer</a>
                                    <span class="d-block fw-medium card-amount">34.57 ETH</span>
                                </div>
                            </div>
                        </div><!-- end card -->
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="card-creator-v card-creator-v-wbg card-creator-v-wbg-s1 pt-0 pb-4">
                            <div class="card-creator-info">
                                <a href="author.html" class="avatar avatar-1 flex-shrink-0 mb-2">
                                    <img src="images/thumb/avatar-12.jpg" alt="avatar">
                                    <span class="card-creator-number">12</span>
                                </a>
                                <div class="flex-grow-1">
                                    <a href="author.html" class="card-title">Karla Sharp</a>
                                    <span class="d-block fw-medium card-amount">34.57 ETH</span>
                                </div>
                            </div>
                        </div><!-- end card -->
                    ...
                    <div class="swiper-wrapper">
                        <div class="swiper-slide h-auto">
                            <div class="card card-hiw card-hiw-s3 card-full">
                                <div class="card-body">
                                    <h4 class="mb-3 card-title"><em class="ni ni-question icon icon-sm text-orange icon-circle icon-wbg shadow-sm me-2"></em> What is a non-fungible token (NFT)?</h4>
                                    <p class="card-text">A non-fungible token (NFT) is a cryptographic token that represents a unique asset. They function as verifiable proofs of authenticity and ownership within a blockchain network.</p>
                                </div><!-- end card-body -->
                            </div>
                        </div><!-- end swiper-slide -->
                        <div class="swiper-slide h-auto">
                            <div class="card card-hiw card-hiw-s3 card-full">
                                <div class="card-body">
                                    <h4 class="mb-3 card-title"><em class="ni ni-question icon icon-sm text-orange icon-circle icon-wbg shadow-sm me-2"></em> What is EnftyMart NFT Marketplace?</h4>
                                    <p class="card-text">EnftyMart NFT Marketplace brings together artists, creators, and crypto enthusiasts on a single platform to create and trade top NFTs. The platform features 3 product lines.</p>
                                </div><!-- end card-body -->
                            </div>
                        </div><!-- end swiper-slide -->
                        <div class="swiper-slide h-auto">
                            <div class="card card-hiw card-hiw-s3 card-full">
                                <div class="card-body">
                                    <h4 class="mb-3 card-title"><em class="ni ni-question icon icon-sm text-orange icon-circle icon-wbg shadow-sm me-2"></em> How do I create an NFT?</h4>
                                    <p class="card-text">Click [Create] and choose your file to upload. We currently support JPG, PNG, GIF, PDF, MP4, MP3, MPEG, AVI, WAV, and SVG. Please note that your NFT cannot be changed.</p>
                                </div><!-- end card-body -->
                            </div>
                        </div><!-- end swiper-slide -->
                        <div class="swiper-slide h-auto">
                            <div class="card card-hiw card-hiw-s3 card-full">
                                <div class="card-body">
                                    <h4 class="mb-3 card-title"><em class="ni ni-question icon icon-sm text-orange icon-circle icon-wbg shadow-sm me-2"></em> How do I buy an NFT?</h4>
                                    <p class="card-text">For NFTs with a fixed price, click the [Buy] button on the product page and complete the transaction. Once the transaction is successful, we will transfer the NFT to your wallet.</p>
                                </div><!-- end card-body -->
                            </div>
                        </div><!-- end swiper-slide -->
                        <div class="swiper-slide h-auto">
                            <div class="card card-hiw card-hiw-s3 card-full">
                                <div class="card-body">
                                    <h4 class="mb-3 card-title"><em class="ni ni-question icon icon-sm text-orange icon-circle icon-wbg shadow-sm me-2"></em> How do I sell an NFT?</h4>
                                    <p class="card-text">To list an NFT for sale, our team will first of all approve the content to make sure it’s appropriate for listing. This process usually takes 4-8 hours. Upon successful approval.</p>
                                </div><!-- end card-body -->
                            </div>
                        </div><!-- end swiper-slide -->
                    </div><!-- end swiper-wrapper -->

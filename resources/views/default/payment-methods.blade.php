...
<head>
    ...
    <title>Payment Methods | EnftyMart - NFT Marketplace HTML Template</title>
    <!-- Favicon -->
                ...
                <div class="row">
                    <div class="col-lg-3">
                        <div class="sidebar-head d-flex flex-wrap align-items-center justify-content-between">
                            <h3 class="sidebar-head-title">Payment Methods</h3>
                        ...
                        <div class="sidebar sidebar-user-mobile">
                            ...
                            <div class="sidebar-widget">
                                <ul class="user-nav">
                                    <li><a href="account.html"><em class="ni ni-edit me-2"></em>Edit Profile</a></li>
                                    <li class="active"><a href="payment-methods.html"><em class="ni ni-money me-2"></em>Payment Methods</a></li>
                                    <li><a href="seller-settings.html"><em class="ni ni-user me-2"></em>Seller Settings</a></li>
                                    <li><a href="notifications.html"><em class="ni ni-bell me-2"></em>Notifications</a></li>
                                    <li><a href="security.html"><em class="ni ni-lock me-2"></em>Security</a></li>
                                </ul>
                        ...
                        <div class="profile-setting-panel-wrap">
                            <ul class="nav nav-tabs nav-tabs-s1 nav-tabs-mobile-size" id="myTab" role="tablist">
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link active" id="balances-tab" data-bs-toggle="tab" data-bs-target="#balances" type="button" role="tab" aria-controls="balances" aria-selected="true"> Balances </button>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="credit-cards-tab" data-bs-toggle="tab" data-bs-target="#credit-cards" type="button" role="tab" aria-controls="credit-cards" aria-selected="false"> Credit Cards </button>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="prepaid-eth-tab" data-bs-toggle="tab" data-bs-target="#prepaid-eth" type="button" role="tab" aria-controls="prepaid-eth" aria-selected="false"> Prepaid ETH </button>
                                </li>
                            </ul>
                                ...
                                <div class="tab-pane fade show active" id="balances" role="tabpanel" aria-labelledby="balances-tab">
                                    <div class="profile-setting-panel">
                                        <div class="mb-3 text-black balance-wrap">
                                            <span class="me-3 fw-semibold fs-12">Balance:</span>
                                            <span class="fw-medium fs-10">$330.00</span>
                                        </div>
                                        <div class="mb-2 text-black balance-wrap">
                                            <span class="me-3 fw-semibold fs-12">Holds:</span>
                                            <span class="fw-medium fs-10">$330.00</span>
                                        </div>
                                        <p class="fs-13 mb-4">There is a $5,000 weekly cash out limit with a bank account.</p>
                                        <a href="#" class="fs-13 mb-2 d-inline-block" data-bs-toggle="modal" data-bs-target="#addBankAccountModal">Connect A Bank Account <em class="ni ni-chevron-right ms-1"></em></a>
                                        <ul class="btns-group d-flex">
                                            <li>
                                                <a href="#" class="btn btn-outline-primary">Cash out to Bank</a>
                                            </li>
                                            <li>
                                                <a href="#" class="btn btn-light">View Cashout history</a>
                                            </li>
                                        </ul>
                                ...
                                <div class="tab-pane fade" id="credit-cards" role="tabpanel" aria-labelledby="credit-cards-tab">
                                    <div class="profile-setting-panel">
                                        <div class="alert alert-info mt-4 d-flex mb-5" role="alert">
                                            ...
                                            <p class="fs-14">Using a Capital One card may lead to issues completing purchases. Please consider using a different card until further notice.</p>
                                        </div><!-- end alert -->
                                        <h5 class="mb-4">Your Saved Credit Cards:</h5>
                                        <div class="row g-gs">
                                            <div class="col-md-6">
                                                <div class="card card-full card-credit">
                                                    <div class="card-header d-flex align-items-center">
                                                        <img src="images/thumb/visa.png" alt="" class="me-3 flex-shrink-0">
                                                        <div>
                                                            <span>Visa ending in 8203</span>
                                                            <span class="text-secondary smaller">08/11/2022</span>
                                                        </div>
                                                    </div><!-- card-header -->
                                                    <div class="card-body">
                                                        <h6 class="mb-2">Billing address</h6>
                                                        <p class="fs-14">123 Fake Sreet, 3rd Floor, San Francisco, California, 94105, United States</p>
                                                    </div><!-- card-body -->
                                                    <div class="card-footer">
                                                        <ul class="btns-group btns-group-2">
                                            ...
                                            <div class="col-md-6">
                                                <div class="card card-full card-credit">
                                                    <div class="card-header d-flex align-items-center">
                                                        <img src="images/thumb/master-card.png" alt="" class="me-3 flex-shrink-0">
                                                        <div>
                                                            <span>Mastercard ending in 4720</span>
                                                            <span class="text-secondary smaller">02/9/2022</span>
                                                        </div>
                                                    </div><!-- card-header -->
                                                    <div class="card-body">
                                                        <h6 class="mb-2">Billing address</h6>
                                                        <p class="fs-14">240 Descano Drive, Level 5, San Francisco, California, 34105, United States</p>
                                                    </div><!-- card-body -->
                                                    <div class="card-footer">
                                                        <ul class="btns-group btns-group-2">
                                                            <li><a href="#" class="btn btn-sm bg-danger-dim" data-bs-toggle="modal" data-bs-target="#deleteModal">Delete</a></li>
                                        ...
                                        <a href="#" class="btn btn-dark mt-4" data-bs-toggle="modal" data-bs-target="#addNewCardModal">Add New Card</a>
                                    </div><!-- end profile-setting-panel -->
                                </div><!-- end tab-pane -->
                                <div class="tab-pane fade" id="prepaid-eth" role="tabpanel" aria-labelledby="prepaid-eth-tab">
                                    <div class="profile-setting-panel">
                                        <h5 class="mb-2">Pre-Paid ETH Balance</h5>
                                        <p class="mb-3 fs-14">Balances can be withdrawn in ETH at anytime</p>
                                        <p class="mb-3 fs-14">To increase your balance, send ETH to your deposit address below. ETH will be valued at USD market value at time of purchase. Gas fees will be subtracted from withdrawal amounts.</p>
                                        <div class="d-flex align-items-center">
                                            <div class="me-5 text-black">
                                                <span class="fw-semibold fs-12 d-block mb-2">Balance</span>
                                                <span class="fw-medium fs-9 mb-2">2 ETH</span>
                                                <span class="d-block">$330.00 USD</span>
                                            </div>
                                            <div class="text-black">
                                                <span class="fw-semibold fs-12 d-block mb-2">Holds</span>
                                                <span class="fw-medium fs-9 mb-2">2 ETH</span>
                                                <span class="d-block">$330.00 USD</span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="d-flex align-items-center border p-3 rounded-3">
                                            <input type="text" class="copy-input copy-input-s1" value="0x01948694c481cd38231261095f606c0a9444ce0e" id="copy-input" readonly>
                                            <div class="tooltip-s1">
                                                <button data-clipboard-target="#copy-input" class="copy-text" type="button">
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-body text-center">
                    ...
                    <h4 class="modal-tilte mb-2">Your card will be deleted permanently!</h4>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-sm btn-danger" data-bs-dismiss="modal">Ok Delete</button>
                </div>

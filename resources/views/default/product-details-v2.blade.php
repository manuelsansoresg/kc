        ...
        <section class="item-detail-section">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="item-detail-info-wrap mt-5">
                            <div class="row g-gs">
                                    ...
                                    <div class="card-border card-full">
                                        <div class="card-body card-body-s1">
                                            ...
                                            <div class="item-detail-list">
                                                <div class="card-media card-media-s2">
                                                    <a href="author.html" class="card-media-img flex-shrink-0 d-block">
                                                        <img src="images/thumb/avatar.jpg" alt="avatar">
                                                    </a>
                                                    <div class="card-media-body">
                                                        <h5 class="fw-semibold"><a href="author.html" class="text-black">French Montana</a></h5>
                                                ...
                                                <div class="card-media card-media-s2">
                                                    ...
                                                    <div class="card-media-body">
                                                        <h5 class="fw-semibold"><a href="author.html" class="text-black">Beejaey</a></h5>
                                            ...
                                            <div class="item-detail-list">
                                                <div class="card-media card-media-s2">
                                                    ...
                                                    <div class="card-media-body text-truncate">
                                                        <h5 class="fw-semibold text-truncate">0.072 ETH by Palliman for 1 edition</h5>
                                                ...
                                                <div class="card-media card-media-s2">
                                                    ...
                                                    <div class="card-media-body text-truncate">
                                                        <h5 class="fw-semibold text-truncate">0.072 ETH by KingKhalid for 1 edition</h5>
                                                ...
                                                <div class="card-media card-media-s2">
                                                    ...
                                                    <div class="card-media-body text-truncate">
                                                        <h5 class="fw-semibold text-truncate">0.072 ETH by Kamran for 1 edition</h5>
                                        ...
                                        <div class="card-body card-body-s1">
                                            ...
                                            <div class="item-detail-list">
                                                <div class="card-media card-media-s2">
                                                    ...
                                                    <div class="card-media-body text-truncate">
                                                        <h5 class="fw-semibold text-truncate">Listed 1 edition for 0.35 ETH</h5>
                                                ...
                                                <div class="card-media card-media-s2">
                                                    ...
                                                    <div class="card-media-body text-truncate">
                                                        <h5 class="fw-semibold text-truncate">Purchased 1 edition for 0.1 ETH</h5>
                                                        <p class="small">by <a href="author.html" class="text-primary">Medicom</a> 20 hours ago</p>
                                                    </div><!-- end card-media-body -->
                                                </div><!-- end card-media -->
                                                <div class="card-media card-media-s2">
                                                    <a href="author.html" class="card-media-img flex-shrink-0 d-block">
                                                    ...
                                                    <div class="card-media-body text-truncate">
                                                        <h5 class="fw-semibold text-truncate">Purchased 1 edition for 0.1 ETH</h5>
                                                        <p class="small">by <a href="author.html" class="text-primary">Medicom</a> 19 hours ago</p>
                                                    </div><!-- end card-media-body -->
                                                </div><!-- end card-media -->
                                            </div><!-- end item-detail-list -->
                                        </div><!-- end card-body -->

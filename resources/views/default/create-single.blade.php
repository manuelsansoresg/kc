...
<head>
    ...
    <title>Create Single Item | EnftyMart - NFT Marketplace HTML Template</title>
    <!-- Favicon -->
                ...
                <div class="row">
                    <div class="col-lg-8 mx-auto">
                        <div class="section-head-sm">
                            <a href="create.html" class="btn-link fw-semibold"><em class="ni ni-arrow-left"></em> Manage collectible type</a>
                            <h1 class="mt-2">Create single collectible</h1>
                        ...
                        <form action="#" class="form-create mb-5 mb-lg-0">
                            ...
                            <div class="form-item mb-4">
                                ...
                                <ul class="row g-3 nav nav-tabs nav-tabs-s2" id="myTab" role="tablist">
                                    <li class="nav-item col-4 col-sm-4 col-lg-3" role="presentation">
                                        <button class="nav-link active" id="fixed-price-tab" data-bs-toggle="tab" data-bs-target="#fixed-price" type="button" role="tab" aria-controls="fixed-price" aria-selected="true">
                                            <em class="ni ni-tags nav-link-icon"></em>
                                            <span class="nav-link-title mt-1 d-block">Fixed Price</span>
                                        </button>
                                    </li>
                                    <li class="nav-item col-4 col-sm-4 col-lg-3" role="presentation">
                                        <button class="nav-link" id="timed-auction-tab" data-bs-toggle="tab" data-bs-target="#timed-auction" type="button" role="tab" aria-controls="timed-auction" aria-selected="false">
                                            <em class="ni ni-clock nav-link-icon"></em>
                                            <span class="nav-link-title mt-1 d-block">Timed Auction</span>
                                        </button>
                                    </li>
                                    <li class="nav-item col-4 col-sm-4 col-lg-3" role="presentation">
                                        <button class="nav-link" id="open-for-bids-tab" data-bs-toggle="tab" data-bs-target="#open-for-bids" type="button" role="tab" aria-controls="open-for-bids" aria-selected="false">
                                            <em class="ni ni-file-text nav-link-icon"></em>
                                            <span class="nav-link-title mt-1 d-block">Open for bids</span>
                                        </button>
                                    </li>
                                </ul>
                            ...
                            <div class="form-item mb-4">
                                ...
                                <div class="form-choice-wrap">
                                    <select class="form-choice">
                                        ...
                                        <option value="2">Patternlicious</option>
                                        <option value="3">Skecthify</option>
                                        <option value="4">Cartoonism</option>
                                        <option value="5">Virtuland</option>
                                        <option value="6">Papercut</option>
                                    </select>
                                </div>
                            </div><!-- end form-item -->
                            <div class="form-item mb-4">

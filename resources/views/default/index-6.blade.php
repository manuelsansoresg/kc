                    ...
                    <div class="row">
                        <div class="col-md-9 mx-auto">
                            <div class="hero-content py-0 text-center">
                                <h1 class="hero-title hero-title-lg mb-4">Discover, collect, and sell extraordinary NFT's Assets</h1>
                                <p class="hero-text hero-text-s2 px-lg-5">We are all new crypto-collectibles marketplace from arts, music, games to domains, and many more in the list. Now you can buy &amp; sell rare items.</p>
                                <ul class="btns-group hero-btns">
                                    <li><a href="explore-v4.html" class="btn btn-lg btn-dark">Explore</a></li>
        ...
        <section class="section-space trending-section bg-primary-dark is-theme">
            <div class="container">
                ...
                <div class="text-center mt-4 mt-md-5">
                    <a href="explore-v4.html" class="btn-link btn-link-s1">View all auctions</a>
                </div>
            </div><!-- end container -->
                    ...
                    <div class="col-10 col-sm-6 col-lg-3">
                        <div class="card-hiw card-hiw-s3">
                            <div class="d-flex align-items-center mb-3">
                                <span class="icon ni ni-wallet icon-md icon-circle icon-wbg me-3 text-blue bg-blue-100"></span>
                                <h5>Set up your wallet</h5>
                            </div>
                            <p class="card-text-s1">Once you’ve set up your wallet of choice, connect it to EnftyMart by clicking the wallet icon.</p>
                        </div>
                    </div><!-- end col -->
                    <div class="col-10 col-sm-6 col-lg-3">
                        <div class="card-hiw card-hiw-s3">
                            <div class="d-flex align-items-center mb-3">
                                <span class="icon ni ni-file-text icon-md icon-circle icon-wbg me-3 text-purple bg-purple-100"></span>
                                <h5>Create collection</h5>
                            </div>
                            <p class="card-text-s1">Click <a href="profile.html" class="btn-link">My Collections</a> and set up your collection. Add social links, a description of item.</p>
                        </div>
                    </div><!-- end col -->
                    <div class="col-10 col-sm-6 col-lg-3">
                        <div class="card-hiw card-hiw-s3">
                            <div class="d-flex align-items-center mb-3">
                                <span class="icon ni ni-camera icon-md icon-circle icon-wbg me-3 text-pink bg-pink-100"></span>
                                <h5>Add your NFTs</h5>
                            </div>
                            <p class="card-text-s1">Upload your work (image, video, audio, or 3D art), add a title and description to item.</p>
                        </div>
                    </div><!-- end col -->
                    <div class="col-10 col-sm-6 col-lg-3">
                        <div class="card-hiw card-hiw-s3">
                            <div class="d-flex align-items-center mb-3">
                                <span class="icon ni ni-money icon-md icon-circle icon-wbg me-3 text-orange bg-orange-100"></span>
                                <h5>List them for sale</h5>
                            </div>
                            <p class="card-text-s1">Choose between auctions, fixed-price listings, and declining-price listings of item.</p>
                        </div>
                    </div><!-- end col -->
                </div><!-- end row -->
            </div><!-- end container -->

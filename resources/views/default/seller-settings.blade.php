...
<head>
    ...
    <title>Seller Settings | EnftyMart - NFT Marketplace HTML Template</title>
    <!-- Favicon -->
                ...
                <div class="row">
                    <div class="col-lg-3">
                        <div class="sidebar-head d-flex flex-wrap align-items-center justify-content-between">
                            <h3 class="sidebar-head-title">Seller Settings</h3>
                        ...
                        <div class="sidebar sidebar-user-mobile">
                            ...
                            <div class="sidebar-widget">
                                <ul class="user-nav">
                                    ...
                                    <li><a href="payment-methods.html"><em class="ni ni-money me-2"></em>Payment Methods</a></li>
                                    <li class="active"><a href="seller-settings.html"><em class="ni ni-user me-2"></em>Seller Settings</a></li>
                    ...
                    <div class="col-lg-9 ps-xl-5">
                        ...
                        <div class="profile-setting-panel-wrap">
                            <p class="fs-14 mb-3">Current <strong>Authorized Seller </strong> Status: <strong class="text-warning">Restricted</strong></p>
                            <p class="fs-14 mb-3">You must be an authorized seller in order to sell Enfties on EnftyMart. To authorize your account for sales, please sign in to Stripe Connect.</p>
                            <p class="fs-14 mb-3">Even if you can't become an authorized seller, you can still use the rest of EnftyMart: buy & collect Enfties, gift them to other users, or withdraw them to an external wallet.</p>
                            <ul class="btns-group btns-group-full-mobile">
                                <li>
                                    <div class="form-choice-wrap form-choice-wrap-2">
                                    ...
                                    </div><!-- end select-choice-wrap -->
                                </li>
                                <li>
                                    <a href="#" class="btn btn-dark">Authorize Seller Account</a>
                                </li>
                            </ul>
                            <hr class="my-4">
                            <p class="fs-13">If your country does not appear, it may not be supported by Stripe Connect. Please contact <a href="contact.html" class="btn-link">customer support</a>
                            </p>

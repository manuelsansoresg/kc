...
<head>
    ...
    <title>Wallet Connect | EnftyMart - NFT Marketplace HTML Template</title>
    <!-- Favicon -->
            ...
            <div class="container">
                <div class="row g-gs">
                    <div class="col-sm-6 col-md-4 col-xl-4">
                        <a href="login.html" class="card-media card-full card-media-s1 flex-column justify-content-center flex-wrap p-4">
                            <img src="images/thumb/metamask.svg" alt="logo" class="card-media-img flex-shrink-0 me-0 mb-3">
                            <h6 class="mb-3">Metamask</h6>
                            <span class="btn btn-sm btn-outline-secondary">Connect</span>
                        </a><!-- end card -->
                    </div><!-- end col -->
                    <div class="col-sm-6 col-md-4 col-xl-4">
                        <a href="login.html" class="card-media card-full card-media-s1 flex-column justify-content-center flex-wrap p-4">
                            <img src="images/thumb/bitski.svg" alt="logo" class="card-media-img flex-shrink-0 me-0 mb-3">
                            <h6 class="mb-3">Bitski</h6>
                            <span class="btn btn-sm btn-outline-secondary">Connect</span>
                        </a><!-- end card -->
                    </div><!-- end col -->
                    <div class="col-sm-6 col-md-4 col-xl-4">
                        <a href="login.html" class="card-media card-full card-media-s1 flex-column justify-content-center flex-wrap p-4">
                            <img src="images/thumb/fortmatic.svg" alt="logo" class="card-media-img flex-shrink-0 me-0 mb-3">
                            <h6 class="mb-3">Fortmatic</h6>
                            <span class="btn btn-sm btn-outline-secondary">Connect</span>
                        </a><!-- end card -->
                    </div><!-- end col -->
                    <div class="col-sm-6 col-md-4 col-xl-4">
                        <a href="login.html" class="card-media card-full card-media-s1 flex-column justify-content-center flex-wrap p-4">
                            <img src="images/thumb/torus.svg" alt="logo" class="card-media-img flex-shrink-0 me-0 mb-3">
                            <h6 class="mb-3">Torus</h6>
                            <span class="btn btn-sm btn-outline-secondary">Connect</span>
                        </a><!-- end card -->
                    </div><!-- end col -->
                    <div class="col-sm-6 col-md-4 col-xl-4">
                        <a href="login.html" class="card-media card-full card-media-s1 flex-column justify-content-center flex-wrap p-4">
                            <img src="images/thumb/coinbase.svg" alt="logo" class="card-media-img flex-shrink-0 me-0 mb-3">
                            <h6 class="mb-3">Coinbase</h6>
                            <span class="btn btn-sm btn-outline-secondary">Connect</span>
                        </a><!-- end card -->
                    </div><!-- end col -->
                    <div class="col-sm-6 col-md-4 col-xl-4">
                        <a href="login.html" class="card-media card-full card-media-s1 flex-column justify-content-center flex-wrap p-4">
                            <img src="images/thumb/wallet-connect.svg" alt="logo" class="card-media-img flex-shrink-0 me-0 mb-3">
                            <h6 class="mb-3">WalletConnect</h6>
                            <span class="btn btn-sm btn-outline-secondary">Connect</span>
                        </a><!-- end card -->
                    </div><!-- end col -->
                    <div class="col-sm-6 col-md-4 col-xl-4">

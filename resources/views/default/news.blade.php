...
<head>
    ...
    <title>News/Blog | EnftyMart - NFT Marketplace HTML Template</title>
    <!-- Favicon -->
            ...
            <div class="container">
                <div class="row g-gs">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="card card-full card-blog">
                            <a href="news-detail.html" class="d-block card-image">
                                <img src="images/thumb/blog-img-5.jpg" class="card-img-top" alt="">
                                <div class="bg-dark-transparent card-overlay">
                                    <div class="d-flex align-items-center card-author">
                                        <div class="flex-shrink-0 avatar avatar-2">
                                            <img src="images/thumb/avatar-5.jpg" alt="">
                                        </div>
                                        <div class="flex-grow-1 ms-2 text-white">
                                            <span>Jhon Doe</span>
                                        </div>
                            ...
                            <div class="card-body card-body-s1">
                                <h4 class="card-title mb-3">
                                    <a href="news-detail.html">The Biggest Drop In Times Square Since New Year</a>
                                </h4>
                                <p class="card-text">Art world friends and confidants share their thoughts on championing</p>
                            </div><!-- end card-body -->
                            <hr class="my-0">
                            <div class="card-body card-body-s1 py-3">
                                <div class="card-action-info">
                                    <span>
                                        <em class="ni ni-calender-date me-1"></em>11 May 2022 </span>
                                    <span>
                                        <span class="me-3">
                                            <em class="ni ni-comments me-1"></em>21 </span>
                                        <span>
                                            <em class="ni ni-heart me-1"></em>11 </span>
                                    </span>
                                </div><!-- end card-action-info -->
                            </div><!-- end card-body -->
                        </div><!-- end card -->
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="card card-full card-blog">
                            <a href="news-detail.html" class="d-block card-image">
                                <img src="images/thumb/blog-img-6.jpg" class="card-img-top" alt="">
                                <div class="bg-dark-transparent card-overlay">
                                    <div class="d-flex align-items-center card-author">
                                        <div class="flex-shrink-0 avatar avatar-2">
                                            <img src="images/thumb/avatar-6.jpg" alt="">
                                        </div>
                                        <div class="flex-grow-1 ms-2 text-white">
                                            <span>Jhon Doe</span>
                                        </div>
                            ...
                            <div class="card-body card-body-s1">
                                <h4 class="card-title mb-3">
                                    <a href="news-detail.html">Daz 3d, The Digitals And Ground breaking</a>
                                </h4>
                                <p class="card-text">You want to succeed, surround yourself with the right kind of people.</p>
                            </div><!-- end card-body -->
                            <hr class="my-0">
                            <div class="card-body card-body-s1 py-3">
                                <div class="card-action-info">
                                    <span>
                                        <em class="ni ni-calender-date me-1"></em>12 May 2022 </span>
                                    <span>
                                        <span class="me-3">
                                            <em class="ni ni-comments me-1"></em>23 </span>
                                        <span>
                                            <em class="ni ni-heart me-1"></em>11 </span>
                                    </span>
                                </div><!-- end card-action-info -->
                ...
                <div class="pagination-wrap">
                    ...
                    <p class="text-center mt-3 page-result-text">Showing 1 to 6 of 12 records</p>
                </div>
            </div><!-- .container -->

...
<head>
    ...
    <title>Security | EnftyMart - NFT Marketplace HTML Template</title>
    <!-- Favicon -->
                ...
                <div class="row">
                    <div class="col-lg-3">
                        <div class="sidebar-head d-flex flex-wrap align-items-center justify-content-between">
                            <h3 class="sidebar-head-title">Security</h3>
                        ...
                        <div class="sidebar sidebar-user-mobile">
                            ...
                            <div class="sidebar-widget">
                                <ul class="user-nav">
                                    ...
                                    <li class="active"><a href="security.html"><em class="ni ni-lock me-2"></em>Security</a></li>
                                </ul>
                    ...
                    <div class="col-lg-9 ps-xl-5">
                        ...
                        <div class="profile-setting-panel-wrap">
                            <h5 class="mb-2">How Does it Work?</h5>
                            <p class="fs-14 mb-4">EnftyMart uses <a href="#" class="btn-link text-primary">Authy</a> as a 2fa provider. On enrollment in 2fa, we will send you a link to download authy and a code to confirm your phone number. You will then recieve 2fa requests through this app.</p>
                            <ul class="btns-group">
                                <li>
                                    <a href="#"><img src="images/thumb/google-play.png" alt=""></a>
                                </li>
                                <li>
                                    <a href="#"><img src="images/thumb/app-store.png" alt=""></a>
                                </li>
                            </ul>
                            ...
                            <ul class="btns-group">
                                <li>
                                    <input type="password" id="phoneNumber" class="form-control form-control-s1 phone-number">
                                </li>
                                <li>

...
<head>
    ...
    <title>Deposit | EnftyMart - NFT Marketplace HTML Template</title>
    <!-- Favicon -->
                ...
                <div class="row">
                    <div class="col-lg-3">
                        <div class="sidebar-head d-flex flex-wrap align-items-center justify-content-between">
                            <h3 class="sidebar-head-title">Deposit Enfties</h3>
                        ...
                        <div class="sidebar sidebar-user-mobile">
                            ...
                            <div class="sidebar-widget">
                                <ul class="user-nav">
                                    ...
                                    <li class="active"><a href="deposit.html"><em class="ni ni-download-cloud me-2"></em>Deposit Enfties</a></li>
                                </ul>
                    ...
                    <div class="col-lg-9 ps-xl-5">
                        <div class="user-panel-title-box">
                            <h3>Deposit Enfties</h3>
                        </div><!-- end user-panel-title-box -->
                        <div class="profile-setting-panel-wrap">
                            <p class="mb-4">Only EnftyMart collection Enfties can be deposited. To check if your Enfty <br> is eligible for deposit, click <a href="#" class="btn-link" data-bs-toggle="modal" data-bs-target="#depositNiftyModal">Here</a>
                            </p>
                            <a href="wallet.html" class="btn btn-outline-dark"><em class="ni ni-plus"></em> Connect a new wallet</a>
                            <p class="fs-14 mt-3">Metamask browser extension is required. Visit <a href="https://metamask.io/" target="_blank">metamask.io</a> to learn more.</p>
        ...
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">Deposit Enfty</h4>
                    <button type="button" class="btn-close icon-btn" data-bs-dismiss="modal" aria-label="Close">
                        <em class="ni ni-cross"></em>
                    </button>
                </div>
                <div class="modal-body">
                    <p class="mb-3 fs-14">Only Enfties registered in Enfty Gateway collections can be deposited. Check if your Enfty is compatible below: </p>
                    ...
                    <div class="qrcode-wrap d-flex align-items-center mb-4">
                        <img src="images/thumb/qrcode.png" alt="" class="me-3 flex-shirnk-0">
                        <p class="fs-14">Scan QR code or send your nifty to the address above</p>
                    </div>
                    <div class="d-flex align-items-center">
                        <input type="text" class="copy-input" value="0x76669f...a0e9ca52" id="copy-input" readonly>
                    ...
                    <h6 class="text-uppercase mt-3 fw-medium">Do not send cryptocurrency to this address</h6>
                </div><!-- end modal-body -->

...
<head>
    ...
    <title>News Details | EnftyMart - NFT Marketplace HTML Template</title>
    <!-- Favicon -->
...
<body>
    <div class="page-wrap">
            ...
            <div class="hero-wrap sub-header">
                <div class="container">
                    <div class="hero-content text-center py-0">
                        <h1>Enter Linda Dounia's Cyber Baat World</h1>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb breadcrumb-s1 justify-content-center mt-3 mb-0">
                                <li class="breadcrumb-item"><a href="/">Home</a></li>
                                <li class="breadcrumb-item"><a href="news.html">Blog</a></li>
                                <li class="breadcrumb-item active" aria-current="page">Enter Linda Dounia...</li>
                            </ol>
                        </nav>
                    </div><!-- hero-content -->
                </div><!-- .container-->
        ...
        <section class="blog-section section-space-b">
            <div class="container">
                <div class="row">
                    <div class="col-lg-8">
                        <div class="single-entry mb-5 mb-lg-0">
                            <img src="images/thumb/blog-img.jpg" class="w-100 rounded mb-3" alt="">
                            ...
                            <p class="single-entry-text mb-3">Predictions for how secondary NFT sales will revolutionize creative industries. Elementum lacus, tempus aliquam turpis diam amet leo enim. Nisi enim condimentum tincidunt ornare nam adipiscing. Volutpat lacus, est hendrerit elit sed interdum. amet leo enim.</p>
                            <p class="single-entry-text mb-3">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Elementum lacus, tempus aliquam turpis diam amet leo enim. Nisi enim condimentum tincidunt ornare nam adipiscing. Volutpat lacus, est hendrerit elit sed interdum. amet leo enim.</p>
                            <blockquote class="blockquote">
                                <p>Design can be art. Design can be simple. That’s why it’s so complicated. Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam.</p>
                            </blockquote>
                            <p class="single-entry-text mb-4">A small river named Duden flows by their place and supplies it with the necessary regelialia. It is a paradisematic country, in which roasted parts of sentences fly into your mouth. There live the blind texts.</p>
                            <div class="row g-gs mb-4">
                                <div class="col-lg-6 col-sm-6">
                                    <img src="images/thumb/blog-img.jpg" class="w-100 rounded" alt="">
                                </div>
                                <div class="col-lg-6 col-sm-6">
                                    <img src="images/thumb/blog-img-2.jpg" class="w-100 rounded" alt="">
                                </div>
                            </div><!-- end row -->
                            <p class="single-entry-text mb-3">Astro ipsum dolor sit amet, consectetur adipiscing elit. Elementum lacus, tempus aliquam turpis diam amet leo enim. Nisi enim condimentum tincidunt ornare nam adipiscing. Volutpat lacus, est hendrerit elit sed interdum. amet leo enim.</p>
                            <h4 class="mb-2">Submit Your Work</h4>
                            <p class="single-entry-text mb-2">Quis sunt quis do laboris eiusmod in sint dolore sit pariatur consequat commodo aliqua nulla ad dolor aliquip incididunt voluptate est aliquip adipisicing ea cupidatat nostrud incididunt aliquip dolore. Sed minim nisi duis laborum est labore nisi amet elit adipisicing proident do consectetur dolor labore sit nisi ad proident.</p>
                            <div class="gap-2x"></div>
                            <hr class="mt-0">
                            <div class="d-flex flex-wrap align-items-center justify-content-between">
                                <ul class="tag-list my-1">
                                    <li class="me-2 text-black fw-semibold">Tags:</li>
                                    <li><a href="#" class="tag-link">Vision</a></li>
                                    <li><a href="#" class="tag-link">Music</a></li>
                                </ul>
                                        ...
                                        <div class="comment">
                                            ...
                                            <div class="comment-body">
                                                <div class="d-flex align-items-center justify-content-between">
                                                    <div class="me-2">
                                                        <h5 class="comment-title">Olivia</h5>
                                                        <span class="comment-meta">15 January 2020</span>
                                                    </div>
                                                    <a class="btn-link comment-replay-btn" href="#">
                                                        <em class="ni ni-reply"></em> Reply </a>
                                                </div>
                                            ...
                                            <li>
                                                <div class="comment">
                                                    ...
                                                    <div class="comment-body">
                                                        <div class="d-flex align-items-center justify-content-between">
                                                            <div class="me-2">
                                                                <h5 class="comment-title">John Smith</h5>
                                                                <span class="comment-meta">23 Feb 2020</span>
                                                            </div>
                                                            <a class="btn-link comment-replay-btn" href="#">
                                                                <em class="ni ni-reply"></em> Reply </a>
                                                        </div>
                                    ...
                                    <li>
                                        <div class="comment">
                                            ...
                                            <div class="comment-body">
                                                <div class="d-flex align-items-center justify-content-between">
                                                    <div class="me-2">
                                                        <h5 class="comment-title">Mark Hardson</h5>
                            ...
                            <div class="col-lg-12 sidebar-widget">
                                <div class="card">
                                    <div class="card-body card-body-s1">
                                        ...
                                        <form action="#">
                                            <div class="input-group">
                                                <input type="text" class="form-control form-control-s1" placeholder="Search post">
                            ...
                            <div class="col-md-6 col-lg-12 sidebar-widget">
                                <div class="card">
                                    <div class="card-body card-body-s1">
                                        ...
                                        <ul class="list-item">
                                            <li><a href="news.html"><em class="ni ni-chevron-right me-1"></em> Art</a></li>
                                            <li><a href="news.html"><em class="ni ni-chevron-right me-1"></em> Virtual Worlds</a></li>
                                            <li><a href="news.html"><em class="ni ni-chevron-right me-1"></em> Collectibles</a></li>
                                            <li><a href="news.html"><em class="ni ni-chevron-right me-1"></em> Music</a></li>
                                            <li><a href="news.html"><em class="ni ni-chevron-right me-1"></em> Games</a></li>
                                            <li><a href="news.html"><em class="ni ni-chevron-right me-1"></em> Domains</a></li>
                                            <li><a href="news.html"><em class="ni ni-chevron-right me-1"></em> Memes</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div><!-- end sidebar-widget -->
                                    ...
                                    <div class="card-body card-body-s1">
                                        ...
                                        <ul class="posts">
                                            <li class="d-flex align-items-center">
                                                <a href="news-detail.html" class="thumbnail flex-shrink-0 me-3">
                                                    <img src="images/thumb/small-img.jpg" alt="">
                                                </a>
                                                <div class="flex-grow-1">
                                                    <h6 class="posts-title mb-1"><a href="news-detail.html">Announcing Our $100m Raise</a></h6>
                                                    <p class="posts-meta">July 13, 2021</p>
                                                </div>
                                            </li>
                                            <li class="d-flex align-items-center">
                                                <a href="news-detail.html" class="thumbnail flex-shrink-0 me-3">
                                                    <img src="images/thumb/small-img-2.jpg" alt="">
                                                </a>
                                                <div class="flex-grow-1">
                                                    <h6 class="posts-title mb-1"><a href="news-detail.html">Edition365: A Portrait Of The Year That</a></h6>
                                                    <p class="posts-meta">Jun 23, 2021</p>
                                                </div>
                                            </li>
                                            <li class="d-flex align-items-center">
                                                <a href="news-detail.html" class="thumbnail flex-shrink-0 me-3">
                                                    <img src="images/thumb/small-img-3.jpg" alt="">
                                                </a>
                                                <div class="flex-grow-1">
                                                    <h6 class="posts-title mb-1"><a href="news-detail.html">Artist interview: Arran Schonberg</a></h6>
                                                    <p class="posts-meta">May 12, 2021</p>
                                                </div>
                                            </li>
                                        </ul>
                                    </div>
                            ...
                            <div class="col-md-6 col-lg-12 sidebar-widget">
                                <div class="card">
                                    <div class="card-body card-body-s1">
                                        ...
                                        <ul class="tag-list">
                                            <li><a href="#" class="tag-link">Virtual World</a></li>
                                            <li><a href="#" class="tag-link">Art</a></li>
                                            <li><a href="#" class="tag-link">Vision</a></li>
                                            <li><a href="#" class="tag-link">Music</a></li>
                                            <li><a href="#" class="tag-link">Domains</a></li>
                                            <li><a href="#" class="tag-link">Print</a></li>
                                            <li><a href="#" class="tag-link">Programming</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div><!-- end sidebar-widget -->

...
<body>
    <div class="page-wrap">
        <header class="header-section has-header-main bg-gradient-primary is-theme bg-pattern-2 no-theme-switcher">
            <div class="header-main is-sticky is-transparent on-dark">
                <div class="container">
            ...
            <div class="hero-wrap sub-header sub-header-2">
                <div class="container">
                ...
                <div class="filter-container row g-gs">
                    <div class="col-xl-3 col-lg-4 col-sm-6 filter-item artworks">
                        <div class="card card-full card-s3">
                            ...
                            <div class="card-body px-0 pb-0">
                                <h5 class="card-title text-truncate"><a href="product-details-v3.html">One Tribe Black Edition</a></h5>
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6 filter-item artworks">
                        <div class="card card-full card-s3">
                            ...
                            <div class="card-body px-0 pb-0">
                                <h5 class="card-title text-truncate"><a href="product-details-v3.html">Operation Jade Fury</a></h5>
                                <div class="card-price-wrap d-flex align-items-center justify-content-sm-between">
                                    <div class="me-5 me-sm-2">
                                        <span class="card-price-title">Price</span>
                                        <span class="card-price-number">$14.20</span>
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6 filter-item artworks">
                        <div class="card card-full card-s3">
                            ...
                            <div class="card-body px-0 pb-0">
                                <h5 class="card-title text-truncate"><a href="product-details-v3.html">Unboxing The Compass</a></h5>
                                <div class="card-price-wrap d-flex align-items-center justify-content-sm-between">
                                    <div class="me-5 me-sm-2">
                                        <span class="card-price-title">Price</span>
                                        <span class="card-price-number">$14.20</span>
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6 filter-item artworks">
                        <div class="card card-full card-s3">
                            ...
                            <div class="card-body px-0 pb-0">
                                <h5 class="card-title text-truncate"><a href="product-details-v3.html">Rendering by the Water</a></h5>
                                <div class="card-price-wrap d-flex align-items-center justify-content-sm-between">
                                    <div class="me-5 me-sm-2">
                                        <span class="card-price-title">Price</span>
                                        <span class="card-price-number">$14.20</span>
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6 filter-item music">
                        <div class="card card-full card-s3">
                            ...
                            <div class="card-body px-0 pb-0">
                                <h5 class="card-title text-truncate"><a href="product-details-v3.html">Divine Opulence</a></h5>
                                <div class="card-price-wrap d-flex align-items-center justify-content-sm-between">
                                    <div class="me-5 me-sm-2">
                                        <span class="card-price-title">Price</span>
                                        <span class="card-price-number">$14.20</span>
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6 filter-item music">
                        <div class="card card-full card-s3">
                            ...
                            <div class="card-body px-0 pb-0">
                                <h5 class="card-title text-truncate"><a href="product-details-v3.html">Sacral Metatron Cube</a></h5>
                                <div class="card-price-wrap d-flex align-items-center justify-content-sm-between">
                                    <div class="me-5 me-sm-2">
                                        <span class="card-price-title">Price</span>
                                        <span class="card-price-number">$14.20</span>
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6 filter-item collectibles">
                        <div class="card card-full card-s3">
                            ...
                            <div class="card-body px-0 pb-0">
                                <h5 class="card-title text-truncate"><a href="product-details-v3.html">Girl warming up to a bed acrobat</a></h5>
                                <div class="card-price-wrap d-flex align-items-center justify-content-sm-between">
                                    <div class="me-5 me-sm-2">
                                        <span class="card-price-title">Price</span>
                                        <span class="card-price-number">$14.20</span>
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6 filter-item collectibles">
                        <div class="card card-full card-s3">
                            ...
                            <div class="card-body px-0 pb-0">
                                <h5 class="card-title text-truncate"><a href="product-details-v3.html">Women Eyes Modern Art</a></h5>
                                <div class="card-price-wrap d-flex align-items-center justify-content-sm-between">
                                    <div class="me-5 me-sm-2">
                                        <span class="card-price-title">Price</span>
                                        <span class="card-price-number">$14.20</span>
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6 filter-item games">
                        <div class="card card-full card-s3">
                            ...
                            <div class="card-body px-0 pb-0">
                                <h5 class="card-title text-truncate"><a href="product-details-v3.html">Puffy Baby Bird #151</a></h5>
                                <div class="card-price-wrap d-flex align-items-center justify-content-sm-between">
                                    <div class="me-5 me-sm-2">
                                        <span class="card-price-title">Price</span>
                                        <span class="card-price-number">$14.20</span>
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6 filter-item games">
                        <div class="card card-full card-s3">
                            ...
                            <div class="card-body px-0 pb-0">
                                <h5 class="card-title text-truncate"><a href="product-details-v3.html">Wave1 - Titanium Ticket</a></h5>
                                <div class="card-price-wrap d-flex align-items-center justify-content-sm-between">
                                    <div class="me-5 me-sm-2">
                                        <span class="card-price-title">Price</span>
                                        <span class="card-price-number">$14.20</span>
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6 filter-item games">
                        <div class="card card-full card-s3">
                            ...
                            <div class="card-body px-0 pb-0">
                                <h5 class="card-title text-truncate"><a href="product-details-v3.html">Saggezza 2/4. Cartier Edition</a></h5>
                                <div class="card-price-wrap d-flex align-items-center justify-content-sm-between">
                                    <div class="me-5 me-sm-2">
                                        <span class="card-price-title">Price</span>
                                        <span class="card-price-number">$14.20</span>
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6 filter-item artworks">
                        <div class="card card-full card-s3">
                            ...
                            <div class="card-body px-0 pb-0">
                                <h5 class="card-title text-truncate"><a href="product-details-v3.html">Venus (Viktoria Veisbrut & SoldArt)</a></h5>
                                <div class="card-price-wrap d-flex align-items-center justify-content-sm-between">
                                    <div class="me-5 me-sm-2">
                                        <span class="card-price-title">Price</span>
                                        <span class="card-price-number">$14.20</span>
        ...
        <footer class="footer-section bg-primary-darker is-theme">
            <div class="container">

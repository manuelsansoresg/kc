        ...
        <section class="explore-section pt-lg-4">
            <div class="container">
                ...
                <div class="filter-container row g-gs">
                    <div class="col-lg-6 filter-item artworks">
                        <div class="card card-full flex-sm-row product-s2">
                            <div class="card-image">
                                <img src="images/thumb/nft-2.jpg" class="product-img" alt="art image">
                            </div><!-- end card-image -->
                            <div class="card-body p-4">
                                ...
                                <div class="card-price-wrap d-flex align-items-center justify-content-sm-between mb-3">
                                    <div class="me-5 me-sm-2">
                                        ...
                                        <span class="card-price-number">$10.00</span>
                                    </div>
                    ...
                    <div class="col-lg-6 filter-item artworks">
                        <div class="card card-full flex-sm-row product-s2">
                            <div class="card-image">
                                <img src="images/thumb/nft3.jpg" class="product-img" alt="art image">
                            </div><!-- end card-image -->
                            <div class="card-body p-4">
                                ...
                                <div class="card-price-wrap d-flex align-items-center justify-content-sm-between mb-3">
                                    ...
                                    <div class="text-sm-end">
                                        <span class="card-price-title">Current bid</span>
                                        <span class="card-price-number">2.32 ETH</span>
                                    </div>
                                </div><!-- end card-price-wrap -->
                                <a href="product-details-v1.html" class="btn btn-sm btn-dark">Place Bid</a>
                            </div>
                    ...
                    <div class="col-lg-6 filter-item artworks">
                        <div class="card card-full flex-sm-row product-s2">
                            <div class="card-image">
                                <img src="images/thumb/nft4.jpg" class="product-img" alt="art image">
                            </div><!-- end card-image -->
                            <div class="card-body p-4">
                    ...
                    <div class="col-lg-6 filter-item music">
                        <div class="card card-full flex-sm-row product-s2">
                            <div class="card-image">
                                <img src="images/thumb/nft5.jpg" class="product-img" alt="art image">
                            </div><!-- end card-image -->
                            <div class="card-body p-4">
                    ...
                    <div class="col-lg-6 filter-item music">
                        <div class="card card-full flex-sm-row product-s2">
                            <div class="card-image">
                                <img src="images/thumb/nft6.jpg" class="product-img" alt="art image">
                            </div><!-- end card-image -->
                            <div class="card-body p-4">
                    ...
                    <div class="col-lg-6 filter-item collectibles">
                        <div class="card card-full flex-sm-row product-s2">
                            <div class="card-image">
                                <img src="images/thumb/nft7.jpg" class="product-img" alt="art image">
                            </div><!-- end card-image -->
                            <div class="card-body p-4">
                    ...
                    <div class="col-lg-6 filter-item collectibles">
                        <div class="card card-full flex-sm-row product-s2">
                            <div class="card-image">
                                <img src="images/thumb/nft8.jpg" class="product-img" alt="art image">
                            </div><!-- end card-image -->
                            <div class="card-body p-4">
                    ...
                    <div class="col-lg-6 filter-item games">
                        <div class="card card-full flex-sm-row product-s2">
                            <div class="card-image">
                                <img src="images/thumb/nft9.jpg" class="product-img" alt="art image">
                            </div><!-- end card-image -->
                            <div class="card-body p-4">
                                ...
                                <div class="card-author mb-1 d-flex align-items-center">
                                    ...
                                    <div class="custom-tooltip-wrap">
                                        ...
                                        <div class="card-generic custom-tooltip-dropdown">
                                            ...
                                            <h6 class="author-name mb-1">MoveNetwork</h6>
                                            <p class="author-desc smaller mb-3">Complete account of the system, and expound the actual things.</p>
                                            <div class="follow-wrap mb-3">
                                                <h6 class="mb-1 smaller text-uppercase">Followed by</h6>
                                                <div class="avatar-group">

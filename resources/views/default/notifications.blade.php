...
<head>
    ...
    <title>Notification | EnftyMart - NFT Marketplace HTML Template</title>
    <!-- Favicon -->
                ...
                <div class="row">
                    <div class="col-lg-3">
                        <div class="sidebar-head d-flex flex-wrap align-items-center justify-content-between">
                            <h3 class="sidebar-head-title">Notifications</h3>
                        ...
                        <div class="sidebar sidebar-user-mobile">
                            ...
                            <div class="sidebar-widget">
                                <ul class="user-nav">
                                    ...
                                    <li class="active"><a href="notifications.html"><em class="ni ni-bell me-2"></em>Notifications</a></li>
                        ...
                        <div class="profile-setting-panel-wrap">
                            <ul class="nav nav-tabs nav-tabs-s1 nav-tabs-mobile-size" id="myTab" role="tablist">
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link active" id="email-alerts-tab" data-bs-toggle="tab" data-bs-target="#email-alerts" type="button" role="tab" aria-controls="email-alerts" aria-selected="true"> Email Alerts </button>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="price-alerts-tab" data-bs-toggle="tab" data-bs-target="#price-alerts" type="button" role="tab" aria-controls="price-alerts" aria-selected="false"> Price Alerts </button>
                                </li>
                            </ul>

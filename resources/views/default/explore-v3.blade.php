                            ...
                            <div class="card-body px-0 pb-0">
                                ...
                                <div class="card-price-wrap d-flex align-items-center justify-content-between">
                                    <div class="me-5 me-sm-2">
                                        ...
                                        <span class="card-price-number">0.33 ETH <span class="equivalance">10.00 USD</span></span>
                                    </div>
                                    <a href="product-details-v1.html" class="btn btn-sm bg-dark-dim">Bid</a>
                                </div>
                            </div><!-- end card-body -->
                        </div><!-- end card -->
                    </div><!-- end col -->
                                ...
                                <div class="card-author mb-1 d-flex align-items-center">
                                    ...
                                    <div class="custom-tooltip-wrap">
                                        ...
                                        <div class="card-generic custom-tooltip-dropdown">
                                            ...
                                            <h6 class="author-name mb-1">Viktoria</h6>
                                            <p class="author-desc smaller mb-3">Complete account of the system, and expound the actual things.</p>
                                            <div class="follow-wrap mb-3">
                                                <h6 class="mb-1 smaller text-uppercase">Followed by</h6>
                                                <div class="avatar-group">

...
<head>
    ...
    <title>Activity | EnftyMart - NFT Marketplace HTML Template</title>
    <!-- Favicon -->
        ...
        <section class="activity-section section-space-b">
            <div class="container">
                <ul class="row g-4 nav nav-tabs nav-tabs-s2 justify-content-center" id="myTab" role="tablist">
                    <li class="nav-item col-6 col-sm-4 col-lg-2" role="presentation">
                        <button class="nav-link active" id="all-tab" data-bs-toggle="tab" data-bs-target="#all" type="button" role="tab" aria-controls="all" aria-selected="true">
                            <img src="images/thumb/all.svg" class="icon icon-svg" alt="">
                            <span class="nav-link-title mt-3 d-block">All</span>
                        </button>
                    </li>
                    <li class="nav-item col-6 col-sm-4 col-lg-2" role="presentation">
                        <button class="nav-link" id="art-tab" data-bs-toggle="tab" data-bs-target="#art" type="button" role="tab" aria-controls="art" aria-selected="false">
                            <img src="images/thumb/art.svg" class="icon icon-svg" alt="">
                            <span class="nav-link-title mt-3 d-block">Art</span>
                        </button>
                    </li>
                    <li class="nav-item col-6 col-sm-4 col-lg-2" role="presentation">
                        <button class="nav-link" id="virtual-worlds-tab" data-bs-toggle="tab" data-bs-target="#virtual-worlds" type="button" role="tab" aria-controls="virtual-worlds" aria-selected="false">
                            <img src="images/thumb/virtual-world.svg" class="icon icon-svg" alt="">
                            <span class="nav-link-title mt-3 d-block">Virtual Worlds</span>
                        </button>
                    </li>
                    <li class="nav-item col-6 col-sm-4 col-lg-2" role="presentation">
                        <button class="nav-link" id="trending-cards-tab" data-bs-toggle="tab" data-bs-target="#trending-cards" type="button" role="tab" aria-controls="trending-cards" aria-selected="false">
                            <img src="images/thumb/icon4.svg" class="icon icon-svg" alt="">
                            <span class="nav-link-title mt-3 d-block">Trending Cards</span>
                        </button>
                    </li>
                    <li class="nav-item col-6 col-sm-4 col-lg-2" role="presentation">
                        <button class="nav-link" id="collectibles-tab" data-bs-toggle="tab" data-bs-target="#collectibles" type="button" role="tab" aria-controls="collectibles" aria-selected="false">
                            <img src="images/thumb/icon5.svg" class="icon icon-svg" alt="">
                            <span class="nav-link-title mt-3 d-block">Collectibles</span>
                        </button>
                    </li>
                    <li class="nav-item col-6 col-sm-4 col-lg-2" role="presentation">
                        <button class="nav-link" id="utility-tab" data-bs-toggle="tab" data-bs-target="#utility" type="button" role="tab" aria-controls="utility" aria-selected="false">
                            <img src="images/thumb/icon6.svg" class="icon icon-svg" alt="">
                            <span class="nav-link-title mt-3 d-block">Utility</span>
                        </button>
                    </li>
                </ul>
                            ...
                            <table class="table mb-0 table-s1 fs-13 bg-gray">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>0.001</td>
                                        <td>1</td>
                                        <td><a href="#" class="btn-link fw-regular">lucifer</a></td>
                                        <td><a href="#" class="btn-link fw-regular">MackMoli</a></td>
                                        <td>1 day ago</td>
                                    </tr>
                                    <tr>
                                        <th scope="row" class="fw-regular">Created</th>
                                        ...
                                        <td>-</td>
                                        <td>0</td>
                                        <td><a href="#" class="btn-link fw-regular">NullAddress</a></td>
                                        <td><a href="#" class="btn-link fw-regular">ValourKnight</a></td>
                                        <td>2 days ago</td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>0.02</td>
                                        <td>1</td>
                                        <td><a href="#" class="btn-link fw-regular">rohendra</a></td>
                                        <td><a href="#" class="btn-link fw-regular">amber</a></td>
                                        <td>3 days ago</td>
                                    </tr>
                                    <tr>
                                        <th scope="row" class="fw-regular">List</th>
                                        <td>RChildhood Astronaut</td>
                                        <td>120</td>
                                        <td>1</td>
                                        <td><a href="#" class="btn-link fw-regular">ValourKnight</a></td>
                                        <td><a href="#" class="btn-link fw-regular">noel</a></td>
                                        <td>5 days ago</td>
                                    </tr>
                                    <tr>
                                        <th scope="row" class="fw-regular">Bid</th>
                                    ...
                                    <tr>
                                        <th scope="row" class="fw-regular">Transfer</th>
                                        <td>Song1</td>
                                        <td>0.002</td>
                                        <td>1</td>
                                        <td><a href="#" class="btn-link fw-regular">lucifer</a></td>
                                    ...
                                    <tr>
                                        <th scope="row" class="fw-regular">Bid Cancelled</th>
                                        <td>AN EPIC AUTOGRAPHED BOLLYWOOD FILM POSTER!</td>
                                        <td>-</td>
                                        <td>1</td>
                                        <td><a href="#" class="btn-link fw-regular">0x_arr1975k_29</a></td>
                                        <td></td>
                                        <td>3 weeks ago</td>
                                    </tr>
                                    <tr>
                                        <th scope="row" class="fw-regular">Cancelled</th>
                                        <td>Sunset #1</td>
                                        <td>-</td>
                                        <td>1</td>
                                        <td><a href="#" class="btn-link fw-regular">amber</a></td>
                        ...
                        <div class="table-responsive">
                            <table class="table mb-0 table-s1 fs-13 bg-gray">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <th scope="row" class="fw-regular">List</th>
                                        <td>Bored Starry Night Samurai Club #1</td>
                                        <td>120</td>
                                        <td>1</td>
                                        <td><a href="#" class="btn-link fw-regular">ValourKnight</a></td>
                                        <td><a href="#" class="btn-link fw-regular">noel</a></td>

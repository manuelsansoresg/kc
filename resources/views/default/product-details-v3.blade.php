...
<head>
    ...
    <title>Product Details | EnftyMart - NFT Marketplace HTML Template</title>
    <!-- Favicon -->
...
<body>
    <div class="page-wrap">
        ...
        <section class="item-detail-section bg-primary-dark is-theme">
            <div class="container">
                <div class="row">
                    <div class="col-lg-6 pe-xl-5">
                        <div class="item-detail-content">
                            <div class="item-detail-img-container mb-4">
                                <img src="images/thumb/item-detail.jpg" alt="" class="w-100 rounded-3">
                            </div><!-- end item-detail-img-container -->
                            <div class="item-detail-tab">
                                <ul class="nav nav-tabs nav-tabs-s1" id="myTab" role="tablist">
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link active" id="owners-tab" data-bs-toggle="tab" data-bs-target="#owners" type="button" role="tab" aria-controls="owners" aria-selected="true"> Owners </button>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        ...
                                        <div class="item-detail-tab-wrap">
                                            <div class="card-media card-media-s2 mb-3">
                                                ...
                                                <div class="card-media-body">
                                                    <p class="fw-semibold"><a href="author.html" class="text-black">French Montana</a></p>
                                                    <p class="small">450 editions not for sale</p>
                                                </div>
                                            </div><!-- end card -->
                                            <div class="card-media card-media-s2 mb-3">
                                                <a href="author.html" class="card-media-img flex-shrink-0 d-block">
                                                ...
                                                <div class="card-media-body">
                                                    <p class="fw-semibold"><a href="author.html" class="text-black">Beejaey</a></p>
                                                    <p class="small">6 editions not for sale</p>
                                                </div>
                                            </div><!-- end card -->
                                            <div class="card-media card-media-s2 mb-3">
                                                <a href="author.html" class="card-media-img flex-shrink-0 d-block">
                                                ...
                                                <div class="card-media-body">
                                                    <p class="fw-semibold"><a href="author.html" class="text-black">Tom Dracula</a></p>
                                                    <p class="small">24 editions not for sale</p>
                                                </div>
                                            </div><!-- end card -->
                                    ...
                                    <div class="tab-pane fade" id="bids" role="tabpanel" aria-labelledby="bids-tab">
                                        <div class="item-detail-tab-wrap">
                                            <div class="card-media card-media-s2 mb-3">
                                                ...
                                                <div class="card-media-body">
                                                    <p class="fw-semibold text-black">0.072 ETH by Palliman for 1 edition</p>
                                                    <p class="small">21/09/2021</p>
                                                </div>
                                            </div><!-- end card -->
                                            <div class="card-media card-media-s2 mb-3">
                                                <a href="author.html" class="card-media-img flex-shrink-0 d-block">
                                                ...
                                                <div class="card-media-body">
                                                    <p class="fw-semibold text-black">0.072 ETH by KingKhalid for 1 edition</p>
                                                    <p class="small">14/08/2021</p>
                                                </div>
                                            </div><!-- end card -->
                                            <div class="card-media card-media-s2 mb-3">
                                                <a href="author.html" class="card-media-img flex-shrink-0 d-block">
                                                ...
                                                <div class="card-media-body">
                                                    <p class="fw-semibold text-black">0.072 ETH by Kamran for 1 edition</p>
                                                    <p class="small">12/07/2021</p>
                                                </div>
                                            </div><!-- end card -->
                                        </div><!-- end item-detail-tab-wrap -->
                                    </div><!-- end tab-pane -->
                                    <div class="tab-pane fade" id="history" role="tabpanel" aria-labelledby="history-tab">
                                        <div class="item-detail-tab-wrap">
                                            <div class="card-media card-media-s2 mb-3">
                                                ...
                                                <div class="card-media-body">
                                                    <p class="fw-semibold text-black">Listed 1 edition for 0.35 ETH</p>
                                                    <p class="small">by Medicom 21 hours ago</p>
                                                </div>
                                            </div><!-- end card -->
                                            <div class="card-media card-media-s2 mb-3">
                                                <a href="author.html" class="card-media-img flex-shrink-0 d-block">
                                                ...
                                                <div class="card-media-body">
                                                    <p class="fw-semibold text-black">Purchased 1 edition for 0.1 ETH</p>
                                                    <p class="small">by Medicom 21 hours ago</p>
                                                </div>
                                            </div><!-- end card -->
                                            <div class="card-media card-media-s2 mb-3">
                                                ...
                                                <div class="card-media-body">
                                                    <p class="fw-semibold text-black">Purchased 1 edition for 0.1 ETH</p>
                                                    <p class="small">by French Montana 23/09/2021</p>
                                                </div>
                                            </div><!-- end card -->
                                        </div><!-- end item-detail-tab-wrap -->
                                    </div><!-- end tab-pane -->
                    ...
                    <div class="col-lg-6">
                        <div class="item-detail-content mt-4 mt-lg-0">
                            <h1 class="item-detail-title mb-2">One Tribe Black Edition</h1>
                            ...
                            <p class="item-detail-text mb-4">Digital-only* "CB Galaxy" style Coke Boys LA sneakers wearable in the Decentraland metaverse</p>
                                ...
                                <div class="row g-4">
                                    <div class="col-xl-6">
                                        <div class="card-media card-media-s1">
                                            ...
                                            <div class="card-media-body">
                                                <a href="author.html" class="fw-semibold">@nathan_walls</a>
                                    ...
                                    <div class="col-xl-6">
                                        <div class="card-media card-media-s1">
                                            ...
                                            <div class="card-media-body">
                                                <a href="author.html" class="fw-semibold">@kamran_ahmed</a>
                                    ...
                                    <div class="col-xl-12">
                                        <div class="card-media card-media-s1">
                                            <a href="#" class="card-media-img flex-shrink-0 d-block">
                                                <img src="images/thumb/avatar-3.jpg" alt="avatar">
                                            </a>
                                            <div class="card-media-body">
                                                <p class="fw-semibold text-black">Highest bid by Palliman</p>
                                                <span class="fw-medium small">0.072 ETH</span>
                                            </div>
                                        </div><!-- end card -->
                                    </div><!-- end col-->
                                </div><!-- end row -->
                            ...
                            <div class="item-detail-btns mt-4">
                                <ul class="btns-group d-flex">
                                    ...
                                    <li class="flex-grow-1">
                                        <div class="dropdown">
                                            <a href="#" class="btn bg-dark-dim d-block" data-bs-toggle="dropdown">Share</a>
                                            <div class="dropdown-menu card-generic p-2 w-100 mt-1">
                                                <a href="#" class="dropdown-item card-generic-item"><em class="ni ni-facebook-f me-2"></em> Facebook</a>
                                                <a href="#" class="dropdown-item card-generic-item"><em class="ni ni-twitter me-2"></em> Twitter</a>
                                                <a href="#" class="dropdown-item card-generic-item"><em class="ni ni-instagram me-2"></em> Instagram</a>
                                            </div>
                                        </div>
                                    </li>
                                </ul>
        ...
        <section class="related-product-section section-space bg-primary-dark is-theme">
            <div class="container">
                <div class="section-head text-center">
                    <h2>Popular Art Assets</h2>
                    ...
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide">
                            <div class="card card-full">
                                <a href="product-details-v3.html" class="card-image">
                                    <img src="images/thumb/nft-2.jpg" class="card-img-top" alt="art image">
                                </a>
                                <div class="card-body p-4">
                                    <h5 class="card-title text-truncate mb-0"><a href="product-details-v3.html">One Tribe Black Edition</a></h5>
                                    ...
                                    <a href="product-details-v3.html" class="btn btn-sm btn-dark">Place Bid</a>
                                </div><!-- end card-body -->
                            </div><!-- end card -->
                        ...
                        <div class="swiper-slide">
                            <div class="card card-full">
                                ...
                                <div class="card-body p-4">
                                    <h5 class="card-title text-truncate mb-0"><a href="product-details-v3.html">Operation Jade Fury</a></h5>
                                    <div class="card-author mb-1 d-flex align-items-center">
                                        <span class="me-1 card-author-by">By</span>
                                        <div class="custom-tooltip-wrap">
                        ...
                        <div class="swiper-slide">
                            <div class="card card-full">
                                ...
                                <div class="card-body p-4">
                                    <h5 class="card-title text-truncate mb-0"><a href="product-details-v3.html">Unboxing The Compass</a></h5>
                                    <div class="card-author mb-1 d-flex align-items-center">
                                        <span class="me-1 card-author-by">By</span>
                                        <div class="custom-tooltip-wrap">
                        ...
                        <div class="swiper-slide">
                            <div class="card card-full">
                                ...
                                <div class="card-body p-4">
                                    <h5 class="card-title text-truncate mb-0"><a href="product-details-v3.html">Rendering by the Water</a></h5>
                                    <div class="card-author mb-1 d-flex align-items-center">
                                        <span class="me-1 card-author-by">By</span>
                                        <div class="custom-tooltip-wrap">
                        ...
                        <div class="swiper-slide">
                            <div class="card card-full">
                                ...
                                <div class="card-body p-4">
                                    <h5 class="card-title text-truncate mb-0"><a href="product-details-v3.html">Divine Opulence</a></h5>
                                    <div class="card-author mb-1 d-flex align-items-center">
                                        <span class="me-1 card-author-by">By</span>
                                        <div class="custom-tooltip-wrap">
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p class="mb-3">You are about to place a bid for <strong>The Future is Blossoming - Harlows 2021</strong> from <strong>Nathan walls</strong></p>
                    <div class="mb-3">
                        <label class="form-label">Your bid (ETH)</label>
                        <input type="text" class="form-control form-control-s1" placeholder="Enter bid">
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Enter quantity <span class="text-primary">5 available</span></label>
                        <input type="text" class="form-control form-control-s1" value="1">
                    </div>
                    <ul class="total-bid-list mb-4">
                        <li><span>Your bidding balance</span> <span>0.013325 ETH</span></li>
                        <li><span>Your balance</span> <span>10.67856 ETH</span></li>
                        <li><span>Service fee 3.5%</span> <span>0.00325 ETH</span></li>
                        <li><span>You will pay</span> <span>0.013325 ETH</span></li>
                    </ul>
                    <a href="wallet.html" class="btn btn-dark d-block">Place a Bid</a>
                </div><!-- end modal-body -->

                        ...
                        <div class="tab-pane fade active show" id="analytics1" role="tabpanel">
                            <div class="row align-items-center">
                                <div class="col-md-6 pe-md-5 pe-lg-7 col-sm-9 mb-6 mb-lg-0" data-aos="fade-up"
                                    ...
                                    <div class="row align-items-center">
                                        <div class="col-12">
                                            <h1 class="display-7 mb-5 text-white mt-5"> {{ $client->name }}, estas son las opciones de crédito. </h1>
                                ...
                                <div class="col-md-6 col-lg-5 mx-auto" data-aos="fade-left">
                                    <img class="img-fluid" src="https://kaaxclub.com/images/thumb/item-detail.jpg" alt="">
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row align-items-center justify-content-center">
                        <div class="col-lg-4 px-md-1 px-lg-4 col-sm-10 " data-aos="fade-up"
                            ...
                            <div class="card mb-4 mb-lg-0 shadow-lg rounded-4 border-0 overflow-hidden">
                                ...
                                <div class="card-body pt-0 pb-4 px-4">
                                    <h6 class="display-9"><span class="fw-light small"></span>Calificación: 4.8<span class="small">/5 </span>  </h6><small
                                    ...
                                    <li class="d-flex align-items-center mb-3">
                                        <span
                                            class="material-symbols-rounded align-middle text-warning fs-4 me-3">circle</span>Comisiones: 5 <span class="small">/5</span>
                                           <a href=""> <span
                                            class="material-symbols-rounded align-middle text-warning fs-4 me-3">chevron_right</span></a>
                                        </li>
                                    <li class="d-flex align-items-center mb-3"><span
                                            class="material-symbols-rounded align-middle text-warning fs-4 me-3">circle</span>Plaxo maximo: 5 <span class="small">/5</span></li>
                                    <li class="d-flex align-items-center mb-3"><span
                                            class="material-symbols-rounded align-middle text-warning fs-4 me-3">circle</span>Contrato 4.9<span class="small">/5</span> </li>
                                    <li class="d-flex align-items-center mb-3"><span
                                            class="material-symbols-rounded align-middle text-warning fs-4 me-3">circle</span>Privacidad datos: 4.3<span class="small">/5</span> </li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 px-md-1 px-lg-4 col-sm-10 " data-aos="fade-up">
                            <div class="card mb-4 mb-lg-0 shadow-lg rounded-4 border-0 overflow-hidden"><span
                                ...
                                <div class="card-body pt-0 pb-4 px-4">
                                    <h6 class="display-9"><span class="fw-light small"></span>Calificación: 5<span class="small">/5</span></h6><small
                                        class="text-muted font-monospace mb-4 d-block"></small><button
                                        type="button" class="w-100 btn btn-lg btn-gradient-primary hover-lift">Tramitar</button>
                                    <ul class="list-unstyled mb-0 pt-4">
                                        <li class="d-flex align-items-center mb-3"><span
                                            class="material-symbols-rounded align-middle text-warning fs-4 me-3">circle</span>CAT REAL: 5<span class="small">/5</span></li>
                                    <li class="d-flex align-items-center mb-3"><span
                                            class="material-symbols-rounded align-middle text-warning fs-4 me-3">circle</span>Comisiones: 5<span class="small">/5</span></li>
                                            <li class="d-flex align-items-center mb-3"><span
                                                class="material-symbols-rounded align-middle text-warning fs-4 me-3">circle</span>Plaxo maximo: 5<span class="small">/5</span> </li>
                                    <li class="d-flex align-items-center mb-3"><span
                                            class="material-symbols-rounded align-middle text-warning fs-4 me-3">circle</span>Contrato 5<span class="small">/5</span></li>
                                    <li class="d-flex align-items-center mb-3"><span
                                            class="material-symbols-rounded align-middle text-warning fs-4 me-3">circle</span>Privacidad datos: 5<span class="small">/5</span></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 px-md-1 px-lg-4 col-sm-10 " data-aos="fade-up"
                            ...
                            <div class="card shadow-lg rounded-4 border-0 overflow-hidden">
                                ...
                                <div class="card-body pt-0 pb-4 px-4">
                                    <h6 class="display-9"><span class="fw-light small"></span>Calificación: 3<span class="small">/5</span></h6><small
                                        class="text-muted font-monospace mb-4 d-block"></small><button
                                        type="button" class="w-100 btn btn-lg btn-gradient-secondary hover-lift">Tramitar</button>
                                    <ul class="list-unstyled mb-0 pt-4">
                                        <li class="d-flex align-items-center mb-3"><span
                                            class="material-symbols-rounded align-middle text-warning fs-4 me-3">circle</span>CAT REAL: 3<span class="small">/5</span></li>
                                    <li class="d-flex align-items-center mb-3"><span
                                            class="material-symbols-rounded align-middle text-warning fs-4 me-3">circle</span>Comisiones: 3.2<span class="small">/5</span><span class="small">/5</span></li>
                                            <li class="d-flex align-items-center mb-3"><span
                                                class="material-symbols-rounded align-middle text-warning fs-4 me-3">circle</span>Plaxo maximo: 5<span class="small">/5</span><span class="small">/5</span> </li>
                                    <li class="d-flex align-items-center mb-3"><span
                                            class="material-symbols-rounded align-middle text-warning fs-4 me-3">circle</span>Contrato 3<span class="small">/5</span><span class="small">/5</span></li>
                                    <li class="d-flex align-items-center mb-3"><span
                                            class="material-symbols-rounded align-middle text-warning fs-4 me-3">circle</span>Privacidad datos: 3<span class="small">/5</span><span class="small">/5</span></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 px-md-1 px-lg-4 col-sm-10  mt-5" data-aos="fade-up"
                            data-aos-delay="150">
                            <div class="card shadow-lg rounded-4 border-0 overflow-hidden">
                                <div class="px-4 py-4">
                                ...
                                <div class="card-body pt-0 pb-4 px-4">
                                    <h6 class="display-9"><span class="fw-light small"></span>Calificación: 2<span class="small">/5</span></h6><small
                                        class="text-muted font-monospace mb-4 d-block"></small><button
                                        type="button" class="w-100 btn btn-lg btn-gradient-secondary hover-lift">Tramitar</button>
                                    <ul class="list-unstyled mb-0 pt-4">
                                        <li class="d-flex align-items-center mb-3"><span
                                            class="material-symbols-rounded align-middle text-warning fs-4 me-3">circle</span>CAT REAL: 2<span class="small">/5</span></li>
                                    <li class="d-flex align-items-center mb-3"><span
                                            class="material-symbols-rounded align-middle text-warning fs-4 me-3">circle</span>Comisiones: 3.2<span class="small">/5</span></li>
                                            <li class="d-flex align-items-center mb-3"><span
                                                class="material-symbols-rounded align-middle text-warning fs-4 me-3">circle</span>Plaxo maximo: 5<span class="small">/5</span> </li>
                                    <li class="d-flex align-items-center mb-3"><span
                                            class="material-symbols-rounded align-middle text-warning fs-4 me-3">circle</span>Contrato 3<span class="small">/5</span></li>
                                    <li class="d-flex align-items-center mb-3"><span
                                            class="material-symbols-rounded align-middle text-warning fs-4 me-3">circle</span>Privacidad datos: 3<span class="small">/5</span></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="card-body pt-0 pb-4 px-4">
                                    ...
                                    <ul class="list-unstyled mb-0 pt-4">
                                        <li class="d-flex align-items-center mb-3"><span
                                            class="material-symbols-rounded align-middle text-warning fs-4 me-3">circle</span>CAT REAL: 2<span class="small">/5</span></li>
                                    <li class="d-flex align-items-center mb-3"><span
                                            class="material-symbols-rounded align-middle text-warning fs-4 me-3">circle</span>Comisiones: 2<span class="small">/5</span></li>
                                            <li class="d-flex align-items-center mb-3"><span
                                                class="material-symbols-rounded align-middle text-warning fs-4 me-3">circle</span>Plaxo maximo: 5<span class="small">/5</span> </li>
                                    <li class="d-flex align-items-center mb-3"><span
                                            class="material-symbols-rounded align-middle text-warning fs-4 me-3">circle</span>Contrato 3<span class="small">/5</span></li>
                        ...
                        <div class="tab-pane fade active show" id="analytics1" role="tabpanel">
                            ...
                            <div class="row align-items-center">
                                <div class="col-md-6 pe-md-5 pe-lg-7 col-sm-9 mb-6 mb-lg-0">
                                    <div class="row align-items-center">
                                        <h1 class="position-relative ms-md-n3 ms-lg-0 ms-0 me-lg-n5 fs-1 mb-4" data-aos="fade-up" data-aos-delay="100">Comisiones.</h1>
                                        <p class="mb-4" data-aos="fade-up" data-aos-delay="100">
                                            La <b>comisión por apertura</b> en realidad es un cobro de intereses por adelantado. Sin embargo; hay créditos que pueden ser más convenientes incluso si cobran comisión por apertura. Es mejor fijarse en el <b>CAT real</b>, el cual considera dicha comisión en su cálculo.
                                        </p>
        ...
        <div class="container pt-11 pt-lg-13 position-relative z-index-1">
            <div class="row pb-9 pb-lg-11 pt-lg-5">
                <div class="col-lg-11 mx-auto text-center">
                    ...
                    <p class="mb-5 lead text-white text-opacity-75 mx-auto w-lg-80"  data-aos="fade-up" data-aos-delay="100">Analizamos cada uno de los contratos en busca de cláusulas abusivas o engañosas.
                    </p>
        ...
        <div class="container pt-11 pt-lg-13 position-relative z-index-1">
            <div class="row pb-9 pb-lg-11 pt-lg-5">
                <div class="col-lg-11 mx-auto text-center">
                    ...
                    <p class="mb-5 lead text-white text-opacity-75 mx-auto w-lg-80"  data-aos="fade-up" data-aos-delay="100">

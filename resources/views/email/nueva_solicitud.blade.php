    ...
    <tbody>
          <tr>
            <td style="padding: 30px 30px 15px 30px;">
                <h2 style="font-size: 18px; color: #6576ff; font-weight: 600; margin: 0;">Nueva solicitud de {{ $product->alias }}</h2>
            </td>
        </tr>
        <tr>
            <td style="padding: 0 30px 20px">
                <p style="margin-bottom: 10px;">Hola </p>
                Sólo te notificamos que se ha creado una nueva solicitud para:

                 <br><br>{{ $nombre_completo }}
                <br> <br>
                Revisaremos la solicitud y nos comunicaremos en caso de que se requiera una acción adicional.
                <br><br>

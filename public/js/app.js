...
__webpack_require__(/*! ./components/user/admin */ "./resources/js/components/user/admin.js");
...
/***/ "./resources/js/components/user/admin.js":
/*!***********************************************!*\
  !*** ./resources/js/components/user/admin.js ***!
  \***********************************************/
...
function setDataUser(user_id) {
  axios.get("/panel/user/admin/" + user_id).then(function (response) {
...
$().ready(function () {
  $("#frmadmin").validate({
    ...
    submitHandler: function submitHandler(form, event) {
      ...
      axios.post("/panel/user/admin", data).then(function (response) {
        var result = response.data;
        (0,_utilities__WEBPACK_IMPORTED_MODULE_0__.showInfo)(2);
      })["catch"](function (e) {
        $('#admin_email-error-exist').show();
      });
    }
  ...
  $("#frmpassword").validate({
    ...
    submitHandler: function submitHandler(form, event) {
      ...
      var data = new FormData(new_form);
      axios.post("/panel/user/admin/password/update", data).then(function (response) {
        var result = response.data;
        (0,_utilities__WEBPACK_IMPORTED_MODULE_0__.showInfo)(2);
      })["catch"](function (e) {});
    }

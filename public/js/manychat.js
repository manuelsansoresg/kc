...
(() => {
/*!**********************************!*\
  !*** ./resources/js/manychat.js ***!
  \**********************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var rfc_facil__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! rfc-facil */ "./node_modules/rfc-facil/dist/rfc-facil.es5.js");
...
$(document).ready(function () {
  function calcularRFC() {
    ...
    var segundoApellido = $('input[name="segundo_apellido"]').val();
    var nombres = $('input[name="nombres"]').val(); // Verificar que todos los campos necesarios estén llenos
    ...
    if (nacimiento && primerApellido && segundoApellido && nombres) {
      var _nacimiento$split = nacimiento.split('-'),
          ...
          year = _nacimiento$split2[0],
          month = _nacimiento$split2[1],
          day = _nacimiento$split2[2];

      var rfc = rfc_facil__WEBPACK_IMPORTED_MODULE_0__["default"].forNaturalPerson({
        name: nombres,

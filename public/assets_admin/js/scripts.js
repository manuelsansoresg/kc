  ...
  NioApp.DataTable = function (elm, opt) {
    if ($(elm).exists()) {
      $(elm).each(function () {
        ...
        var isShowing = typeof opt.isShowing !== 'undefined' ? opt.isShowing : true;
        ...
        if (isShowing == true) {
          ...
          var dom_normal = '<"row justify-between g-2' + btn_cls + '"<"col-12 only-search"f><"col-5 col-sm-8 text-end d-none"<"datatable-filter"<"d-flex justify-content-end g-2"' + btn + 'l>>>><"datatable-wrap my-3"t><"row align-items-center"<"col-7 col-sm-12 col-md-9"p><"col-5 col-sm-12 col-md-3 text-start text-md-end"i>>';
        }

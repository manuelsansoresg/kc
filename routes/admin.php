...
Route::group(['prefix' => 'lead'], function () {
    ...
    Route::get('{clientPerson}/{agreement}/{financialProduct}/{leadId}/soad/get', ['\App\Http\Controllers\Panel\LeadController', 'getSod'])->middleware('auth');
    ...
    Route::get('{financialProduct}/{plazo}/{monto}/{total}/{tramitType}/{montoCompraCartera}/getResumen', ['\App\Http\Controllers\Panel\LeadController', 'getResumen'])->middleware('auth');
    ...
    Route::get('{value}/{id}/{lead_id}/check', ['\App\Http\Controllers\Panel\LeadController', 'checkData'])->middleware('auth');
    ...
    Route::get('{agreementId}/{clientPersonId}/getProducts', ['\App\Http\Controllers\Panel\LeadController', 'getProducts'])->middleware('auth');
...
Route::get('inversionista/{investor}/ingresos-mensuales', [\App\Http\Controllers\InvestorController::class, 'ingresosMensuales'])->middleware('auth');
